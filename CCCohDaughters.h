...
// Thu Mar 12 00:39:47 2020 by ROOT version 6.10/02
// from TTree Daughters/Daughters Tree
// found on file: NuCCanalyser_CCCoh_Complete.root
//////////////////////////////////////////////////////////

#ifndef CCCohDaughters_h
#define CCCohDaughters_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           hit_plane[1577];   //[ntrkhits]
   Float_t         hit_charge[1577];   //[ntrkhits]
   ...
   CCCohDaughters(TTree *tree=0);
   virtual ~CCCohDaughters();
...
#ifdef CCCohDaughters_cxx
CCCohDaughters::CCCohDaughters(TTree *tree) : fChain(0) 
{
...
CCCohDaughters::~CCCohDaughters()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CCCohDaughters::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CCCohDaughters::LoadTree(Long64_t entry)
{
...
void CCCohDaughters::Init(TTree *tree)
{
...
void CCCohDaughters::Show(Long64_t entry)
{
...
Int_t CCCohDaughters::Cut(Long64_t entry)
{
...
#endif // #ifdef CCCohDaughters_cxx
