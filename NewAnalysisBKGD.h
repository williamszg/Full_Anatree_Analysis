...
// Tue Apr  9 17:58:39 2019 by ROOT version 6.12/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           genie_primaries_pdg[72];   //[genie_no_primaries]
   Float_t         genie_Eng[72];   //[genie_no_primaries]
   Float_t         genie_Px[72];   //[genie_no_primaries]
   Float_t         genie_Py[72];   //[genie_no_primaries]
   Float_t         genie_Pz[72];   //[genie_no_primaries]
   Float_t         genie_P[72];   //[genie_no_primaries]
   Int_t           genie_status_code[72];   //[genie_no_primaries]
   Float_t         genie_mass[72];   //[genie_no_primaries]
   Int_t           genie_trackID[72];   //[genie_no_primaries]
   Int_t           genie_ND[72];   //[genie_no_primaries]
   Int_t           genie_mother[72];   //[genie_no_primaries]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           geant_list_size_in_tpcAV;
   Int_t           pdg[908];   //[geant_list_size]
   Int_t           status[908];   //[geant_list_size]
   Float_t         Mass[908];   //[geant_list_size]
   Float_t         Eng[908];   //[geant_list_size]
   Float_t         EndE[908];   //[geant_list_size]
   Float_t         Px[908];   //[geant_list_size]
   Float_t         Py[908];   //[geant_list_size]
   Float_t         Pz[908];   //[geant_list_size]
   Float_t         P[908];   //[geant_list_size]
   Float_t         StartPointx[908];   //[geant_list_size]
   Float_t         StartPointy[908];   //[geant_list_size]
   Float_t         StartPointz[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz[908];   //[geant_list_size]
   Float_t         StartT[908];   //[geant_list_size]
   Float_t         EndPointx[908];   //[geant_list_size]
   Float_t         EndPointy[908];   //[geant_list_size]
   Float_t         EndPointz[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz[908];   //[geant_list_size]
   Float_t         EndT[908];   //[geant_list_size]
   Float_t         theta[908];   //[geant_list_size]
   Float_t         phi[908];   //[geant_list_size]
   Float_t         theta_xz[908];   //[geant_list_size]
   Float_t         theta_yz[908];   //[geant_list_size]
   Float_t         pathlen[908];   //[geant_list_size]
   Int_t           inTPCActive[908];   //[geant_list_size]
   Float_t         StartPointx_tpcAV[908];   //[geant_list_size]
   Float_t         StartPointy_tpcAV[908];   //[geant_list_size]
   Float_t         StartPointz_tpcAV[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx_tpcAV[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy_tpcAV[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz_tpcAV[908];   //[geant_list_size]
   Float_t         StartT_tpcAV[908];   //[geant_list_size]
   Float_t         StartE_tpcAV[908];   //[geant_list_size]
   Float_t         StartP_tpcAV[908];   //[geant_list_size]
   Float_t         StartPx_tpcAV[908];   //[geant_list_size]
   Float_t         StartPy_tpcAV[908];   //[geant_list_size]
   Float_t         StartPz_tpcAV[908];   //[geant_list_size]
   Float_t         EndPointx_tpcAV[908];   //[geant_list_size]
   Float_t         EndPointy_tpcAV[908];   //[geant_list_size]
   Float_t         EndPointz_tpcAV[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx_tpcAV[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy_tpcAV[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz_tpcAV[908];   //[geant_list_size]
   Float_t         EndT_tpcAV[908];   //[geant_list_size]
   Float_t         EndE_tpcAV[908];   //[geant_list_size]
   Float_t         EndP_tpcAV[908];   //[geant_list_size]
   Float_t         EndPx_tpcAV[908];   //[geant_list_size]
   Float_t         EndPy_tpcAV[908];   //[geant_list_size]
   Float_t         EndPz_tpcAV[908];   //[geant_list_size]
   Float_t         pathlen_drifted[908];   //[geant_list_size]
   Int_t           inTPCDrifted[908];   //[geant_list_size]
   Float_t         StartPointx_drifted[908];   //[geant_list_size]
   Float_t         StartPointy_drifted[908];   //[geant_list_size]
   Float_t         StartPointz_drifted[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx_drifted[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy_drifted[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz_drifted[908];   //[geant_list_size]
   Float_t         StartT_drifted[908];   //[geant_list_size]
   Float_t         StartE_drifted[908];   //[geant_list_size]
   Float_t         StartP_drifted[908];   //[geant_list_size]
   Float_t         StartPx_drifted[908];   //[geant_list_size]
   Float_t         StartPy_drifted[908];   //[geant_list_size]
   Float_t         StartPz_drifted[908];   //[geant_list_size]
   Float_t         EndPointx_drifted[908];   //[geant_list_size]
   Float_t         EndPointy_drifted[908];   //[geant_list_size]
   Float_t         EndPointz_drifted[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx_drifted[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy_drifted[908];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz_drifted[908];   //[geant_list_size]
   Float_t         EndT_drifted[908];   //[geant_list_size]
   Float_t         EndE_drifted[908];   //[geant_list_size]
   Float_t         EndP_drifted[908];   //[geant_list_size]
   Float_t         EndPx_drifted[908];   //[geant_list_size]
   Float_t         EndPy_drifted[908];   //[geant_list_size]
   Float_t         EndPz_drifted[908];   //[geant_list_size]
   Int_t           NumberDaughters[908];   //[geant_list_size]
   Int_t           Mother[908];   //[geant_list_size]
   Int_t           TrackId[908];   //[geant_list_size]
   Int_t           MergedId[908];   //[geant_list_size]
   Int_t           origin[908];   //[geant_list_size]
   Int_t           MCTruthIndex[908];   //[geant_list_size]
   Int_t           process_primary[908];   //[geant_list_size]
   vector<string>  *processname;
   Int_t           NTrTrajPts[59];   //[no_primaries]
   Double_t        TrueTraj_X[59][5000];   //[no_primaries]
   Double_t        TrueTraj_Y[59][5000];   //[no_primaries]
   Double_t        TrueTraj_Z[59][5000];   //[no_primaries]
   Double_t        TrueTraj_E[59][5000];   //[no_primaries]
   Int_t           no_mcshowers;
   ...
   Short_t         pfp_selfID[722];   //[nPFParticles]
   Short_t         pfp_isPrimary[722];   //[nPFParticles]
   Short_t         pfp_numDaughters[722];   //[nPFParticles]
   Short_t         pfp_daughterIDs[722][100];   //[nPFParticles]
   Short_t         pfp_parentID[722];   //[nPFParticles]
   Short_t         pfp_vertexID[722];   //[nPFParticles]
   Short_t         pfp_isShower[722];   //[nPFParticles]
   Short_t         pfp_isTrack[722];   //[nPFParticles]
   Short_t         pfp_trackID[722];   //[nPFParticles]
   Short_t         pfp_showerID[722];   //[nPFParticles]
   Int_t           pfp_pdgCode[722];   //[nPFParticles]
   Short_t         pfp_numClusters[722];   //[nPFParticles]
   Short_t         pfp_clusterIDs[722][100];   //[nPFParticles]
   Short_t         pfp_isNeutrino[722];   //[nPFParticles]
   Short_t         pfp_numNeutrinos;
   Short_t         pfp_neutrinoIDs[10];
   Short_t         nshowers_pandora;
   Short_t         showerID_pandora[255];   //[nshowers_pandora]
   Short_t         shwr_bestplane_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_length_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_theta_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_thetaxz_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_thetayz_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_phi_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_startdcosx_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_startdcosy_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_startdcosz_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_startx_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_starty_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_startz_pandora[255];   //[nshowers_pandora]
   Float_t         shwr_totEng_pandora[255][3];   //[nshowers_pandora]
   Float_t         shwr_dedx_pandora[255][3];   //[nshowers_pandora]
   Float_t         shwr_mipEng_pandora[255][3];   //[nshowers_pandora]
   Short_t         shwr_hasPFParticle_pandora[255];   //[nshowers_pandora]
   Short_t         shwr_PFParticleID_pandora[255];   //[nshowers_pandora]
   ...
   Short_t         trkId_pandora[412];   //[ntracks_pandora]
   Short_t         trkncosmictags_tagger_pandora[412];   //[ntracks_pandora]
   Float_t         trkcosmicscore_tagger_pandora[412];   //[ntracks_pandora]
   Short_t         trkcosmictype_tagger_pandora[412];   //[ntracks_pandora]
   Short_t         trkncosmictags_containmenttagger_pandora[412];   //[ntracks_pandora]
   Float_t         trkcosmicscore_containmenttagger_pandora[412];   //[ntracks_pandora]
   Short_t         trkcosmictype_containmenttagger_pandora[412];   //[ntracks_pandora]
   Short_t         trkncosmictags_flashmatch_pandora[412];   //[ntracks_pandora]
   Float_t         trkcosmicscore_flashmatch_pandora[412];   //[ntracks_pandora]
   Short_t         trkcosmictype_flashmatch_pandora[412];   //[ntracks_pandora]
   Float_t         trkke_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkrange_pandora[412][3];   //[ntracks_pandora]
   Int_t           trkidtruth_pandora[412][3];   //[ntracks_pandora]
   Short_t         trkorigin_pandora[412][3];   //[ntracks_pandora]
   Int_t           trkpdgtruth_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkefftruth_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkpurtruth_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkpitchc_pandora[412][3];   //[ntracks_pandora]
   Short_t         ntrkhits_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkdedx_pandora[412][3][2000];   //[ntracks_pandora]
   Float_t         trkdqdx_pandora[412][3][2000];   //[ntracks_pandora]
   Float_t         trkresrg_pandora[412][3][2000];   //[ntracks_pandora]
   Float_t         trkxyz_pandora[412][3][2000][3];   //[ntracks_pandora]
   Float_t         trkstartx_pandora[412];   //[ntracks_pandora]
   Float_t         trkstarty_pandora[412];   //[ntracks_pandora]
   Float_t         trkstartz_pandora[412];   //[ntracks_pandora]
   Float_t         trkstartd_pandora[412];   //[ntracks_pandora]
   Float_t         trkendx_pandora[412];   //[ntracks_pandora]
   Float_t         trkendy_pandora[412];   //[ntracks_pandora]
   Float_t         trkendz_pandora[412];   //[ntracks_pandora]
   Float_t         trkendd_pandora[412];   //[ntracks_pandora]
   Float_t         trkACpierceT0_pandora[412];   //[ntracks_pandora]
   Float_t         trkflashT0_pandora[412];   //[ntracks_pandora]
   Float_t         trktrueT0_pandora[412];   //[ntracks_pandora]
   Int_t           trkg4id_pandora[412];   //[ntracks_pandora]
   Int_t           trkorig_pandora[412];   //[ntracks_pandora]
   Float_t         trkpurity_pandora[412];   //[ntracks_pandora]
   Float_t         trkcompleteness_pandora[412];   //[ntracks_pandora]
   Float_t         trktheta_pandora[412];   //[ntracks_pandora]
   Float_t         trkphi_pandora[412];   //[ntracks_pandora]
   Float_t         trkstartdcosx_pandora[412];   //[ntracks_pandora]
   Float_t         trkstartdcosy_pandora[412];   //[ntracks_pandora]
   Float_t         trkstartdcosz_pandora[412];   //[ntracks_pandora]
   Float_t         trkenddcosx_pandora[412];   //[ntracks_pandora]
   Float_t         trkenddcosy_pandora[412];   //[ntracks_pandora]
   Float_t         trkenddcosz_pandora[412];   //[ntracks_pandora]
   Float_t         trkthetaxz_pandora[412];   //[ntracks_pandora]
   Float_t         trkthetayz_pandora[412];   //[ntracks_pandora]
   Float_t         trkmom_pandora[412];   //[ntracks_pandora]
   Float_t         trkmomrange_pandora[412];   //[ntracks_pandora]
   Float_t         trkmommschi2_pandora[412];   //[ntracks_pandora]
   Float_t         trkmommsllhd_pandora[412];   //[ntracks_pandora]
   Float_t         trkmcsfwdmom_pandora[412];   //[ntracks_pandora]
   Float_t         trkmcsfwdll_pandora[412];   //[ntracks_pandora]
   Float_t         trkmcsfwderr_pandora[412];   //[ntracks_pandora]
   Float_t         trkmcsbwdmom_pandora[412];   //[ntracks_pandora]
   Float_t         trkmcsbwdll_pandora[412];   //[ntracks_pandora]
   Float_t         trkmcsbwderr_pandora[412];   //[ntracks_pandora]
   Float_t         trklen_pandora[412];   //[ntracks_pandora]
   Short_t         trksvtxid_pandora[412];   //[ntracks_pandora]
   Short_t         trkevtxid_pandora[412];   //[ntracks_pandora]
   Int_t           trkntraj_pandora[412];   //[ntracks_pandora]
   Int_t           trkpidpdg_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkpidchi_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkpidchipr_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkpidchika_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkpidchipi_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkpidchimu_pandora[412][3];   //[ntracks_pandora]
   Float_t         trkpidpida_pandora[412][3];   //[ntracks_pandora]
   Short_t         trkpidbestplane_pandora[412];   //[ntracks_pandora]
   Short_t         trkhasPFParticle_pandora[412];   //[ntracks_pandora]
   Short_t         trkPFParticleID_pandora[412];   //[ntracks_pandora]
   Short_t         ntracks_pandoraKalmanTrack;
   Short_t         trkId_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_tagger_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_tagger_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_tagger_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_containmenttagger_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_containmenttagger_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_containmenttagger_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_flashmatch_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_flashmatch_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_flashmatch_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkke_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkrange_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkidtruth_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkorigin_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkpdgtruth_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkefftruth_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpurtruth_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpitchc_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         ntrkhits_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkdedx_pandoraKalmanTrack[367][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkdqdx_pandoraKalmanTrack[367][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkresrg_pandoraKalmanTrack[367][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkxyz_pandoraKalmanTrack[367][3][2000][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartx_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstarty_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartz_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartd_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendx_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendy_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendz_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendd_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkACpierceT0_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkflashT0_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trktrueT0_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkg4id_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkorig_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpurity_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcompleteness_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trktheta_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkphi_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosx_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosy_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosz_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosx_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosy_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosz_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkthetaxz_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkthetayz_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmom_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmomrange_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmommschi2_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmommsllhd_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwdmom_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwdll_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwderr_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwdmom_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwdll_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwderr_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Float_t         trklen_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         trksvtxid_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkevtxid_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkntraj_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkpidpdg_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchi_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchipr_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchika_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchipi_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchimu_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidpida_pandoraKalmanTrack[367][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkpidbestplane_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkhasPFParticle_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkPFParticleID_pandoraKalmanTrack[367];   //[ntracks_pandoraKalmanTrack]
   Short_t         ntracks_pmtrack;
   Short_t         trkId_pmtrack[513];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_tagger_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_tagger_pmtrack[513];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_tagger_pmtrack[513];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_containmenttagger_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_containmenttagger_pmtrack[513];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_containmenttagger_pmtrack[513];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_flashmatch_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_flashmatch_pmtrack[513];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_flashmatch_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkke_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkrange_pmtrack[513][3];   //[ntracks_pmtrack]
   Int_t           trkidtruth_pmtrack[513][3];   //[ntracks_pmtrack]
   Short_t         trkorigin_pmtrack[513][3];   //[ntracks_pmtrack]
   Int_t           trkpdgtruth_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkefftruth_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkpurtruth_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkpitchc_pmtrack[513][3];   //[ntracks_pmtrack]
   Short_t         ntrkhits_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkdedx_pmtrack[513][3][2000];   //[ntracks_pmtrack]
   Float_t         trkdqdx_pmtrack[513][3][2000];   //[ntracks_pmtrack]
   Float_t         trkresrg_pmtrack[513][3][2000];   //[ntracks_pmtrack]
   Float_t         trkxyz_pmtrack[513][3][2000][3];   //[ntracks_pmtrack]
   Float_t         trkstartx_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkstarty_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkstartz_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkstartd_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkendx_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkendy_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkendz_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkendd_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkACpierceT0_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkflashT0_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trktrueT0_pmtrack[513];   //[ntracks_pmtrack]
   Int_t           trkg4id_pmtrack[513];   //[ntracks_pmtrack]
   Int_t           trkorig_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkpurity_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkcompleteness_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trktheta_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkphi_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkstartdcosx_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkstartdcosy_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkstartdcosz_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkenddcosx_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkenddcosy_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkenddcosz_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkthetaxz_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkthetayz_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkmom_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkmomrange_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkmommschi2_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkmommsllhd_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkmcsfwdmom_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkmcsfwdll_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkmcsfwderr_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkmcsbwdmom_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkmcsbwdll_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trkmcsbwderr_pmtrack[513];   //[ntracks_pmtrack]
   Float_t         trklen_pmtrack[513];   //[ntracks_pmtrack]
   Short_t         trksvtxid_pmtrack[513];   //[ntracks_pmtrack]
   Short_t         trkevtxid_pmtrack[513];   //[ntracks_pmtrack]
   Int_t           trkntraj_pmtrack[513];   //[ntracks_pmtrack]
   Int_t           trkpidpdg_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkpidchi_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkpidchipr_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkpidchika_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkpidchipi_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkpidchimu_pmtrack[513][3];   //[ntracks_pmtrack]
   Float_t         trkpidpida_pmtrack[513][3];   //[ntracks_pmtrack]
   Short_t         trkpidbestplane_pmtrack[513];   //[ntracks_pmtrack]
   Short_t         trkhasPFParticle_pmtrack[513];   //[ntracks_pmtrack]
   Short_t         trkPFParticleID_pmtrack[513];   //[ntracks_pmtrack]
   ...
   Short_t         vtxId_pandora[659];   //[nvtx_pandora]
   Float_t         vtxx_pandora[659];   //[nvtx_pandora]
   Float_t         vtxy_pandora[659];   //[nvtx_pandora]
   Float_t         vtxz_pandora[659];   //[nvtx_pandora]
   Short_t         vtxhasPFParticle_pandora[659];   //[nvtx_pandora]
   Short_t         vtxPFParticleID_pandora[659];   //[nvtx_pandora]
   Short_t         nvtx_pmtrack;
   Short_t         vtxId_pmtrack[486];   //[nvtx_pmtrack]
   Float_t         vtxx_pmtrack[486];   //[nvtx_pmtrack]
   Float_t         vtxy_pmtrack[486];   //[nvtx_pmtrack]
   Float_t         vtxz_pmtrack[486];   //[nvtx_pmtrack]
   Short_t         vtxhasPFParticle_pmtrack[486];   //[nvtx_pmtrack]
   Short_t         vtxPFParticleID_pmtrack[486];   //[nvtx_pmtrack]
   Short_t         nvtx_trajcluster;
   Short_t         vtxId_trajcluster[513];   //[nvtx_trajcluster]
   Float_t         vtxx_trajcluster[513];   //[nvtx_trajcluster]
   Float_t         vtxy_trajcluster[513];   //[nvtx_trajcluster]
   Float_t         vtxz_trajcluster[513];   //[nvtx_trajcluster]
   Short_t         vtxhasPFParticle_trajcluster[513];   //[nvtx_trajcluster]
   Short_t         vtxPFParticleID_trajcluster[513];   //[nvtx_trajcluster]
