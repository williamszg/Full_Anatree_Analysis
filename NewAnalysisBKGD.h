...
// Sun Jun  2 13:53:47 2019 by ROOT version 6.12/06
// from TTree anatree/analysis tree
// found on file: MCC9_8000Files.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           genie_primaries_pdg[71];   //[genie_no_primaries]
   Float_t         genie_Eng[71];   //[genie_no_primaries]
   Float_t         genie_Px[71];   //[genie_no_primaries]
   Float_t         genie_Py[71];   //[genie_no_primaries]
   Float_t         genie_Pz[71];   //[genie_no_primaries]
   Float_t         genie_P[71];   //[genie_no_primaries]
   Int_t           genie_status_code[71];   //[genie_no_primaries]
   Float_t         genie_mass[71];   //[genie_no_primaries]
   Int_t           genie_trackID[71];   //[genie_no_primaries]
   Int_t           genie_ND[71];   //[genie_no_primaries]
   Int_t           genie_mother[71];   //[genie_no_primaries]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           geant_list_size_in_tpcAV;
   Int_t           pdg[814];   //[geant_list_size]
   Int_t           status[814];   //[geant_list_size]
   Float_t         Mass[814];   //[geant_list_size]
   Float_t         Eng[814];   //[geant_list_size]
   Float_t         EndE[814];   //[geant_list_size]
   Float_t         Px[814];   //[geant_list_size]
   Float_t         Py[814];   //[geant_list_size]
   Float_t         Pz[814];   //[geant_list_size]
   Float_t         P[814];   //[geant_list_size]
   Float_t         StartPointx[814];   //[geant_list_size]
   Float_t         StartPointy[814];   //[geant_list_size]
   Float_t         StartPointz[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz[814];   //[geant_list_size]
   Float_t         StartT[814];   //[geant_list_size]
   Float_t         EndPointx[814];   //[geant_list_size]
   Float_t         EndPointy[814];   //[geant_list_size]
   Float_t         EndPointz[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz[814];   //[geant_list_size]
   Float_t         EndT[814];   //[geant_list_size]
   Float_t         theta[814];   //[geant_list_size]
   Float_t         phi[814];   //[geant_list_size]
   Float_t         theta_xz[814];   //[geant_list_size]
   Float_t         theta_yz[814];   //[geant_list_size]
   Float_t         pathlen[814];   //[geant_list_size]
   Int_t           inTPCActive[814];   //[geant_list_size]
   Float_t         StartPointx_tpcAV[814];   //[geant_list_size]
   Float_t         StartPointy_tpcAV[814];   //[geant_list_size]
   Float_t         StartPointz_tpcAV[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx_tpcAV[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy_tpcAV[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz_tpcAV[814];   //[geant_list_size]
   Float_t         StartT_tpcAV[814];   //[geant_list_size]
   Float_t         StartE_tpcAV[814];   //[geant_list_size]
   Float_t         StartP_tpcAV[814];   //[geant_list_size]
   Float_t         StartPx_tpcAV[814];   //[geant_list_size]
   Float_t         StartPy_tpcAV[814];   //[geant_list_size]
   Float_t         StartPz_tpcAV[814];   //[geant_list_size]
   Float_t         EndPointx_tpcAV[814];   //[geant_list_size]
   Float_t         EndPointy_tpcAV[814];   //[geant_list_size]
   Float_t         EndPointz_tpcAV[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx_tpcAV[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy_tpcAV[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz_tpcAV[814];   //[geant_list_size]
   Float_t         EndT_tpcAV[814];   //[geant_list_size]
   Float_t         EndE_tpcAV[814];   //[geant_list_size]
   Float_t         EndP_tpcAV[814];   //[geant_list_size]
   Float_t         EndPx_tpcAV[814];   //[geant_list_size]
   Float_t         EndPy_tpcAV[814];   //[geant_list_size]
   Float_t         EndPz_tpcAV[814];   //[geant_list_size]
   Float_t         pathlen_drifted[814];   //[geant_list_size]
   Int_t           inTPCDrifted[814];   //[geant_list_size]
   Float_t         StartPointx_drifted[814];   //[geant_list_size]
   Float_t         StartPointy_drifted[814];   //[geant_list_size]
   Float_t         StartPointz_drifted[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx_drifted[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy_drifted[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz_drifted[814];   //[geant_list_size]
   Float_t         StartT_drifted[814];   //[geant_list_size]
   Float_t         StartE_drifted[814];   //[geant_list_size]
   Float_t         StartP_drifted[814];   //[geant_list_size]
   Float_t         StartPx_drifted[814];   //[geant_list_size]
   Float_t         StartPy_drifted[814];   //[geant_list_size]
   Float_t         StartPz_drifted[814];   //[geant_list_size]
   Float_t         EndPointx_drifted[814];   //[geant_list_size]
   Float_t         EndPointy_drifted[814];   //[geant_list_size]
   Float_t         EndPointz_drifted[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx_drifted[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy_drifted[814];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz_drifted[814];   //[geant_list_size]
   Float_t         EndT_drifted[814];   //[geant_list_size]
   Float_t         EndE_drifted[814];   //[geant_list_size]
   Float_t         EndP_drifted[814];   //[geant_list_size]
   Float_t         EndPx_drifted[814];   //[geant_list_size]
   Float_t         EndPy_drifted[814];   //[geant_list_size]
   Float_t         EndPz_drifted[814];   //[geant_list_size]
   Int_t           NumberDaughters[814];   //[geant_list_size]
   Int_t           Mother[814];   //[geant_list_size]
   Int_t           TrackId[814];   //[geant_list_size]
   Int_t           MergedId[814];   //[geant_list_size]
   Int_t           origin[814];   //[geant_list_size]
   Int_t           MCTruthIndex[814];   //[geant_list_size]
   Int_t           process_primary[814];   //[geant_list_size]
   vector<string>  *processname;
   Int_t           NTrTrajPts[58];   //[no_primaries]
   Double_t        TrueTraj_X[58][5000];   //[no_primaries]
   Double_t        TrueTraj_Y[58][5000];   //[no_primaries]
   Double_t        TrueTraj_Z[58][5000];   //[no_primaries]
   Double_t        TrueTraj_E[58][5000];   //[no_primaries]
   Int_t           no_mcshowers;
   Int_t           mcshwr_origin[24];   //[no_mcshowers]
   Int_t           mcshwr_pdg[24];   //[no_mcshowers]
   Int_t           mcshwr_TrackId[24];   //[no_mcshowers]
   vector<string>  *mcshwr_Process;
   Float_t         mcshwr_startX[24];   //[no_mcshowers]
   Float_t         mcshwr_startY[24];   //[no_mcshowers]
   Float_t         mcshwr_startZ[24];   //[no_mcshowers]
   Float_t         mcshwr_endX[24];   //[no_mcshowers]
   Float_t         mcshwr_endY[24];   //[no_mcshowers]
   Float_t         mcshwr_endZ[24];   //[no_mcshowers]
   Float_t         mcshwr_CombEngX[24];   //[no_mcshowers]
   Float_t         mcshwr_CombEngY[24];   //[no_mcshowers]
   Float_t         mcshwr_CombEngZ[24];   //[no_mcshowers]
   Float_t         mcshwr_CombEngPx[24];   //[no_mcshowers]
   Float_t         mcshwr_CombEngPy[24];   //[no_mcshowers]
   Float_t         mcshwr_CombEngPz[24];   //[no_mcshowers]
   Float_t         mcshwr_CombEngE[24];   //[no_mcshowers]
   Float_t         mcshwr_dEdx[24];   //[no_mcshowers]
   Float_t         mcshwr_StartDirX[24];   //[no_mcshowers]
   Float_t         mcshwr_StartDirY[24];   //[no_mcshowers]
   Float_t         mcshwr_StartDirZ[24];   //[no_mcshowers]
   Int_t           mcshwr_isEngDeposited[24];   //[no_mcshowers]
   Int_t           mcshwr_Motherpdg[24];   //[no_mcshowers]
   Int_t           mcshwr_MotherTrkId[24];   //[no_mcshowers]
   vector<string>  *mcshwr_MotherProcess;
   Float_t         mcshwr_MotherstartX[24];   //[no_mcshowers]
   Float_t         mcshwr_MotherstartY[24];   //[no_mcshowers]
   Float_t         mcshwr_MotherstartZ[24];   //[no_mcshowers]
   Float_t         mcshwr_MotherendX[24];   //[no_mcshowers]
   Float_t         mcshwr_MotherendY[24];   //[no_mcshowers]
   Float_t         mcshwr_MotherendZ[24];   //[no_mcshowers]
   Int_t           mcshwr_Ancestorpdg[24];   //[no_mcshowers]
   Int_t           mcshwr_AncesotorTrkId[24];   //[no_mcshowers]
   vector<string>  *mcshwr_AncesotorProcess;
   Float_t         mcshwr_AncestorstartX[24];   //[no_mcshowers]
   Float_t         mcshwr_AncestorstartY[24];   //[no_mcshowers]
   Float_t         mcshwr_AncestorstartZ[24];   //[no_mcshowers]
   Float_t         mcshwr_AncestorendX[24];   //[no_mcshowers]
   Float_t         mcshwr_AncestorendY[24];   //[no_mcshowers]
   Float_t         mcshwr_AncestorendZ[24];   //[no_mcshowers]
   Int_t           no_mctracks;
   Int_t           mctrk_origin[260];   //[no_mctracks]
   Int_t           mctrk_pdg[260];   //[no_mctracks]
   Int_t           mctrk_TrackId[260];   //[no_mctracks]
   vector<string>  *mctrk_Process;
   Float_t         mctrk_startX[260];   //[no_mctracks]
   Float_t         mctrk_startY[260];   //[no_mctracks]
   Float_t         mctrk_startZ[260];   //[no_mctracks]
   Float_t         mctrk_endX[260];   //[no_mctracks]
   Float_t         mctrk_endY[260];   //[no_mctracks]
   Float_t         mctrk_endZ[260];   //[no_mctracks]
   Float_t         mctrk_startX_drifted[260];   //[no_mctracks]
   Float_t         mctrk_startY_drifted[260];   //[no_mctracks]
   Float_t         mctrk_startZ_drifted[260];   //[no_mctracks]
   Float_t         mctrk_endX_drifted[260];   //[no_mctracks]
   Float_t         mctrk_endY_drifted[260];   //[no_mctracks]
   Float_t         mctrk_endZ_drifted[260];   //[no_mctracks]
   Float_t         mctrk_len_drifted[260];   //[no_mctracks]
   Float_t         mctrk_p_drifted[260];   //[no_mctracks]
   Float_t         mctrk_px_drifted[260];   //[no_mctracks]
   Float_t         mctrk_py_drifted[260];   //[no_mctracks]
   Float_t         mctrk_pz_drifted[260];   //[no_mctracks]
   Int_t           mctrk_Motherpdg[260];   //[no_mctracks]
   Int_t           mctrk_MotherTrkId[260];   //[no_mctracks]
   vector<string>  *mctrk_MotherProcess;
   Float_t         mctrk_MotherstartX[260];   //[no_mctracks]
   Float_t         mctrk_MotherstartY[260];   //[no_mctracks]
   Float_t         mctrk_MotherstartZ[260];   //[no_mctracks]
   Float_t         mctrk_MotherendX[260];   //[no_mctracks]
   Float_t         mctrk_MotherendY[260];   //[no_mctracks]
   Float_t         mctrk_MotherendZ[260];   //[no_mctracks]
   Int_t           mctrk_Ancestorpdg[260];   //[no_mctracks]
   Int_t           mctrk_AncesotorTrkId[260];   //[no_mctracks]
   vector<string>  *mctrk_AncesotorProcess;
   Float_t         mctrk_AncestorstartX[260];   //[no_mctracks]
   Float_t         mctrk_AncestorstartY[260];   //[no_mctracks]
   Float_t         mctrk_AncestorstartZ[260];   //[no_mctracks]
   Float_t         mctrk_AncestorendX[260];   //[no_mctracks]
   Float_t         mctrk_AncestorendY[260];   //[no_mctracks]
   Float_t         mctrk_AncestorendZ[260];   //[no_mctracks]
   Short_t         nPFParticles;
   Short_t         pfp_selfID[514];   //[nPFParticles]
   Short_t         pfp_isPrimary[514];   //[nPFParticles]
   Short_t         pfp_numDaughters[514];   //[nPFParticles]
   Short_t         pfp_daughterIDs[514][100];   //[nPFParticles]
   Short_t         pfp_parentID[514];   //[nPFParticles]
   Short_t         pfp_vertexID[514];   //[nPFParticles]
   Short_t         pfp_isShower[514];   //[nPFParticles]
   Short_t         pfp_isTrack[514];   //[nPFParticles]
   Short_t         pfp_trackID[514];   //[nPFParticles]
   Short_t         pfp_showerID[514];   //[nPFParticles]
   Int_t           pfp_pdgCode[514];   //[nPFParticles]
   Short_t         pfp_numClusters[514];   //[nPFParticles]
   Short_t         pfp_clusterIDs[514][100];   //[nPFParticles]
   Short_t         pfp_isNeutrino[514];   //[nPFParticles]
   Short_t         pfp_numNeutrinos;
   Short_t         pfp_neutrinoIDs[10];
   Short_t         nshowers_pandora;
   Short_t         showerID_pandora[261];   //[nshowers_pandora]
   Short_t         shwr_bestplane_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_length_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_theta_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_thetaxz_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_thetayz_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_phi_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_startdcosx_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_startdcosy_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_startdcosz_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_startx_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_starty_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_startz_pandora[261];   //[nshowers_pandora]
   Float_t         shwr_totEng_pandora[261][3];   //[nshowers_pandora]
   Float_t         shwr_dedx_pandora[261][3];   //[nshowers_pandora]
   Float_t         shwr_mipEng_pandora[261][3];   //[nshowers_pandora]
   Short_t         shwr_hasPFParticle_pandora[261];   //[nshowers_pandora]
   Short_t         shwr_PFParticleID_pandora[261];   //[nshowers_pandora]
   ...
   Short_t         showerID_tcshower[16];   //[nshowers_tcshower]
   Short_t         shwr_bestplane_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_length_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_theta_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_thetaxz_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_thetayz_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_phi_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_startdcosx_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_startdcosy_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_startdcosz_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_startx_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_starty_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_startz_tcshower[16];   //[nshowers_tcshower]
   Float_t         shwr_totEng_tcshower[16][3];   //[nshowers_tcshower]
   Float_t         shwr_dedx_tcshower[16][3];   //[nshowers_tcshower]
   Float_t         shwr_mipEng_tcshower[16][3];   //[nshowers_tcshower]
   Short_t         shwr_hasPFParticle_tcshower[16];   //[nshowers_tcshower]
   Short_t         shwr_PFParticleID_tcshower[16];   //[nshowers_tcshower]
   Short_t         ntracks_pandora;
   Short_t         trkId_pandora[290];   //[ntracks_pandora]
   Short_t         trkncosmictags_tagger_pandora[290];   //[ntracks_pandora]
   Float_t         trkcosmicscore_tagger_pandora[290];   //[ntracks_pandora]
   Short_t         trkcosmictype_tagger_pandora[290];   //[ntracks_pandora]
   Short_t         trkncosmictags_containmenttagger_pandora[290];   //[ntracks_pandora]
   Float_t         trkcosmicscore_containmenttagger_pandora[290];   //[ntracks_pandora]
   Short_t         trkcosmictype_containmenttagger_pandora[290];   //[ntracks_pandora]
   Short_t         trkncosmictags_flashmatch_pandora[290];   //[ntracks_pandora]
   Float_t         trkcosmicscore_flashmatch_pandora[290];   //[ntracks_pandora]
   Short_t         trkcosmictype_flashmatch_pandora[290];   //[ntracks_pandora]
   Float_t         trkke_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkrange_pandora[290][3];   //[ntracks_pandora]
   Int_t           trkidtruth_pandora[290][3];   //[ntracks_pandora]
   Short_t         trkorigin_pandora[290][3];   //[ntracks_pandora]
   Int_t           trkpdgtruth_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkefftruth_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkpurtruth_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkpitchc_pandora[290][3];   //[ntracks_pandora]
   Short_t         ntrkhits_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkdedx_pandora[290][3][2000];   //[ntracks_pandora]
   Float_t         trkdqdx_pandora[290][3][2000];   //[ntracks_pandora]
   Float_t         trkresrg_pandora[290][3][2000];   //[ntracks_pandora]
   Float_t         trkxyz_pandora[290][3][2000][3];   //[ntracks_pandora]
   Float_t         trkstartx_pandora[290];   //[ntracks_pandora]
   Float_t         trkstarty_pandora[290];   //[ntracks_pandora]
   Float_t         trkstartz_pandora[290];   //[ntracks_pandora]
   Float_t         trkstartd_pandora[290];   //[ntracks_pandora]
   Float_t         trkendx_pandora[290];   //[ntracks_pandora]
   Float_t         trkendy_pandora[290];   //[ntracks_pandora]
   Float_t         trkendz_pandora[290];   //[ntracks_pandora]
   Float_t         trkendd_pandora[290];   //[ntracks_pandora]
   Float_t         trkACpierceT0_pandora[290];   //[ntracks_pandora]
   Float_t         trkflashT0_pandora[290];   //[ntracks_pandora]
   Float_t         trktrueT0_pandora[290];   //[ntracks_pandora]
   Int_t           trkg4id_pandora[290];   //[ntracks_pandora]
   Int_t           trkorig_pandora[290];   //[ntracks_pandora]
   Float_t         trkpurity_pandora[290];   //[ntracks_pandora]
   Float_t         trkcompleteness_pandora[290];   //[ntracks_pandora]
   Float_t         trktheta_pandora[290];   //[ntracks_pandora]
   Float_t         trkphi_pandora[290];   //[ntracks_pandora]
   Float_t         trkstartdcosx_pandora[290];   //[ntracks_pandora]
   Float_t         trkstartdcosy_pandora[290];   //[ntracks_pandora]
   Float_t         trkstartdcosz_pandora[290];   //[ntracks_pandora]
   Float_t         trkenddcosx_pandora[290];   //[ntracks_pandora]
   Float_t         trkenddcosy_pandora[290];   //[ntracks_pandora]
   Float_t         trkenddcosz_pandora[290];   //[ntracks_pandora]
   Float_t         trkthetaxz_pandora[290];   //[ntracks_pandora]
   Float_t         trkthetayz_pandora[290];   //[ntracks_pandora]
   Float_t         trkmom_pandora[290];   //[ntracks_pandora]
   Float_t         trkmomrange_pandora[290];   //[ntracks_pandora]
   Float_t         trkmommschi2_pandora[290];   //[ntracks_pandora]
   Float_t         trkmommsllhd_pandora[290];   //[ntracks_pandora]
   Float_t         trkmcsfwdmom_pandora[290];   //[ntracks_pandora]
   Float_t         trkmcsfwdll_pandora[290];   //[ntracks_pandora]
   Float_t         trkmcsfwderr_pandora[290];   //[ntracks_pandora]
   Float_t         trkmcsbwdmom_pandora[290];   //[ntracks_pandora]
   Float_t         trkmcsbwdll_pandora[290];   //[ntracks_pandora]
   Float_t         trkmcsbwderr_pandora[290];   //[ntracks_pandora]
   Float_t         trklen_pandora[290];   //[ntracks_pandora]
   Short_t         trksvtxid_pandora[290];   //[ntracks_pandora]
   Short_t         trkevtxid_pandora[290];   //[ntracks_pandora]
   Int_t           trkntraj_pandora[290];   //[ntracks_pandora]
   Int_t           trkpidpdg_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkpidchi_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkpidchipr_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkpidchika_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkpidchipi_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkpidchimu_pandora[290][3];   //[ntracks_pandora]
   Float_t         trkpidpida_pandora[290][3];   //[ntracks_pandora]
   Short_t         trkpidbestplane_pandora[290];   //[ntracks_pandora]
   Short_t         trkhasPFParticle_pandora[290];   //[ntracks_pandora]
   Short_t         trkPFParticleID_pandora[290];   //[ntracks_pandora]
   Short_t         ntracks_pandoraKalmanTrack;
   Short_t         trkId_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_tagger_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_tagger_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_tagger_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_containmenttagger_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_containmenttagger_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_containmenttagger_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_flashmatch_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_flashmatch_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_flashmatch_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkke_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkrange_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkidtruth_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkorigin_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkpdgtruth_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkefftruth_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpurtruth_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpitchc_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         ntrkhits_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkdedx_pandoraKalmanTrack[260][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkdqdx_pandoraKalmanTrack[260][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkresrg_pandoraKalmanTrack[260][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkxyz_pandoraKalmanTrack[260][3][2000][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartx_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstarty_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartz_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartd_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendx_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendy_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendz_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendd_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkACpierceT0_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkflashT0_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trktrueT0_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkg4id_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkorig_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpurity_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcompleteness_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trktheta_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkphi_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosx_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosy_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosz_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosx_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosy_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosz_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkthetaxz_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkthetayz_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmom_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmomrange_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmommschi2_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmommsllhd_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwdmom_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwdll_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwderr_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwdmom_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwdll_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwderr_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Float_t         trklen_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         trksvtxid_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkevtxid_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkntraj_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkpidpdg_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchi_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchipr_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchika_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchipi_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchimu_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidpida_pandoraKalmanTrack[260][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkpidbestplane_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkhasPFParticle_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkPFParticleID_pandoraKalmanTrack[260];   //[ntracks_pandoraKalmanTrack]
   Short_t         ntracks_pandoraKalmanShower;
   Short_t         trkId_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         trkncosmictags_tagger_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcosmicscore_tagger_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         trkcosmictype_tagger_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         trkncosmictags_containmenttagger_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcosmicscore_containmenttagger_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         trkcosmictype_containmenttagger_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         trkncosmictags_flashmatch_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcosmicscore_flashmatch_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         trkcosmictype_flashmatch_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkke_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkrange_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Int_t           trkidtruth_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Short_t         trkorigin_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Int_t           trkpdgtruth_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkefftruth_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpurtruth_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpitchc_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Short_t         ntrkhits_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkdedx_pandoraKalmanShower[171][3][2000];   //[ntracks_pandoraKalmanShower]
   Float_t         trkdqdx_pandoraKalmanShower[171][3][2000];   //[ntracks_pandoraKalmanShower]
   Float_t         trkresrg_pandoraKalmanShower[171][3][2000];   //[ntracks_pandoraKalmanShower]
   Float_t         trkxyz_pandoraKalmanShower[171][3][2000][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartx_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstarty_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartz_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartd_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendx_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendy_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendz_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendd_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkACpierceT0_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkflashT0_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trktrueT0_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Int_t           trkg4id_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Int_t           trkorig_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpurity_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcompleteness_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trktheta_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkphi_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartdcosx_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartdcosy_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartdcosz_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkenddcosx_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkenddcosy_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkenddcosz_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkthetaxz_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkthetayz_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmom_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmomrange_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmommschi2_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmommsllhd_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsfwdmom_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsfwdll_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsfwderr_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsbwdmom_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsbwdll_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsbwderr_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Float_t         trklen_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         trksvtxid_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         trkevtxid_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Int_t           trkntraj_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Int_t           trkpidpdg_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchi_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchipr_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchika_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchipi_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchimu_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidpida_pandoraKalmanShower[171][3];   //[ntracks_pandoraKalmanShower]
   Short_t         trkpidbestplane_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         trkhasPFParticle_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         trkPFParticleID_pandoraKalmanShower[171];   //[ntracks_pandoraKalmanShower]
   Short_t         nvtx_pandora;
   Short_t         vtxId_pandora[491];   //[nvtx_pandora]
   Float_t         vtxx_pandora[491];   //[nvtx_pandora]
   Float_t         vtxy_pandora[491];   //[nvtx_pandora]
   Float_t         vtxz_pandora[491];   //[nvtx_pandora]
   Short_t         vtxhasPFParticle_pandora[491];   //[nvtx_pandora]
   Short_t         vtxPFParticleID_pandora[491];   //[nvtx_pandora]
   Short_t         nvtx_trajcluster;
   Short_t         vtxId_trajcluster[466];   //[nvtx_trajcluster]
   Float_t         vtxx_trajcluster[466];   //[nvtx_trajcluster]
   Float_t         vtxy_trajcluster[466];   //[nvtx_trajcluster]
   Float_t         vtxz_trajcluster[466];   //[nvtx_trajcluster]
   Short_t         vtxhasPFParticle_trajcluster[466];   //[nvtx_trajcluster]
   Short_t         vtxPFParticleID_trajcluster[466];   //[nvtx_trajcluster]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../MCC9_8000Files.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../MCC9_8000Files.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../MCC9_8000Files.root:/analysistree");
