...
// Mon Jun 24 12:44:30 2019 by ROOT version 6.12/06
// from TTree anatree/analysis tree
// found on file: MCC9_CCCoh_New_Sample.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           genie_primaries_pdg[5];   //[genie_no_primaries]
   Float_t         genie_Eng[5];   //[genie_no_primaries]
   Float_t         genie_Px[5];   //[genie_no_primaries]
   Float_t         genie_Py[5];   //[genie_no_primaries]
   Float_t         genie_Pz[5];   //[genie_no_primaries]
   Float_t         genie_P[5];   //[genie_no_primaries]
   Int_t           genie_status_code[5];   //[genie_no_primaries]
   Float_t         genie_mass[5];   //[genie_no_primaries]
   Int_t           genie_trackID[5];   //[genie_no_primaries]
   Int_t           genie_ND[5];   //[genie_no_primaries]
   Int_t           genie_mother[5];   //[genie_no_primaries]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           geant_list_size_in_tpcAV;
   Int_t           pdg[817];   //[geant_list_size]
   Int_t           status[817];   //[geant_list_size]
   Float_t         Mass[817];   //[geant_list_size]
   Float_t         Eng[817];   //[geant_list_size]
   Float_t         EndE[817];   //[geant_list_size]
   Float_t         Px[817];   //[geant_list_size]
   Float_t         Py[817];   //[geant_list_size]
   Float_t         Pz[817];   //[geant_list_size]
   Float_t         P[817];   //[geant_list_size]
   Float_t         StartPointx[817];   //[geant_list_size]
   Float_t         StartPointy[817];   //[geant_list_size]
   Float_t         StartPointz[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz[817];   //[geant_list_size]
   Float_t         StartT[817];   //[geant_list_size]
   Float_t         EndPointx[817];   //[geant_list_size]
   Float_t         EndPointy[817];   //[geant_list_size]
   Float_t         EndPointz[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz[817];   //[geant_list_size]
   Float_t         EndT[817];   //[geant_list_size]
   Float_t         theta[817];   //[geant_list_size]
   Float_t         phi[817];   //[geant_list_size]
   Float_t         theta_xz[817];   //[geant_list_size]
   Float_t         theta_yz[817];   //[geant_list_size]
   Float_t         pathlen[817];   //[geant_list_size]
   Int_t           inTPCActive[817];   //[geant_list_size]
   Float_t         StartPointx_tpcAV[817];   //[geant_list_size]
   Float_t         StartPointy_tpcAV[817];   //[geant_list_size]
   Float_t         StartPointz_tpcAV[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx_tpcAV[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy_tpcAV[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz_tpcAV[817];   //[geant_list_size]
   Float_t         StartT_tpcAV[817];   //[geant_list_size]
   Float_t         StartE_tpcAV[817];   //[geant_list_size]
   Float_t         StartP_tpcAV[817];   //[geant_list_size]
   Float_t         StartPx_tpcAV[817];   //[geant_list_size]
   Float_t         StartPy_tpcAV[817];   //[geant_list_size]
   Float_t         StartPz_tpcAV[817];   //[geant_list_size]
   Float_t         EndPointx_tpcAV[817];   //[geant_list_size]
   Float_t         EndPointy_tpcAV[817];   //[geant_list_size]
   Float_t         EndPointz_tpcAV[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx_tpcAV[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy_tpcAV[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz_tpcAV[817];   //[geant_list_size]
   Float_t         EndT_tpcAV[817];   //[geant_list_size]
   Float_t         EndE_tpcAV[817];   //[geant_list_size]
   Float_t         EndP_tpcAV[817];   //[geant_list_size]
   Float_t         EndPx_tpcAV[817];   //[geant_list_size]
   Float_t         EndPy_tpcAV[817];   //[geant_list_size]
   Float_t         EndPz_tpcAV[817];   //[geant_list_size]
   Float_t         pathlen_drifted[817];   //[geant_list_size]
   Int_t           inTPCDrifted[817];   //[geant_list_size]
   Float_t         StartPointx_drifted[817];   //[geant_list_size]
   Float_t         StartPointy_drifted[817];   //[geant_list_size]
   Float_t         StartPointz_drifted[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx_drifted[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy_drifted[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz_drifted[817];   //[geant_list_size]
   Float_t         StartT_drifted[817];   //[geant_list_size]
   Float_t         StartE_drifted[817];   //[geant_list_size]
   Float_t         StartP_drifted[817];   //[geant_list_size]
   Float_t         StartPx_drifted[817];   //[geant_list_size]
   Float_t         StartPy_drifted[817];   //[geant_list_size]
   Float_t         StartPz_drifted[817];   //[geant_list_size]
   Float_t         EndPointx_drifted[817];   //[geant_list_size]
   Float_t         EndPointy_drifted[817];   //[geant_list_size]
   Float_t         EndPointz_drifted[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx_drifted[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy_drifted[817];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz_drifted[817];   //[geant_list_size]
   Float_t         EndT_drifted[817];   //[geant_list_size]
   Float_t         EndE_drifted[817];   //[geant_list_size]
   Float_t         EndP_drifted[817];   //[geant_list_size]
   Float_t         EndPx_drifted[817];   //[geant_list_size]
   Float_t         EndPy_drifted[817];   //[geant_list_size]
   Float_t         EndPz_drifted[817];   //[geant_list_size]
   Int_t           NumberDaughters[817];   //[geant_list_size]
   Int_t           Mother[817];   //[geant_list_size]
   Int_t           TrackId[817];   //[geant_list_size]
   Int_t           MergedId[817];   //[geant_list_size]
   Int_t           origin[817];   //[geant_list_size]
   Int_t           MCTruthIndex[817];   //[geant_list_size]
   Int_t           process_primary[817];   //[geant_list_size]
   vector<string>  *processname;
   Int_t           NTrTrajPts[3];   //[no_primaries]
   Double_t        TrueTraj_X[3][5000];   //[no_primaries]
   Double_t        TrueTraj_Y[3][5000];   //[no_primaries]
   Double_t        TrueTraj_Z[3][5000];   //[no_primaries]
   Double_t        TrueTraj_E[3][5000];   //[no_primaries]
   Int_t           no_mcshowers;
   Int_t           mcshwr_origin[22];   //[no_mcshowers]
   Int_t           mcshwr_pdg[22];   //[no_mcshowers]
   Int_t           mcshwr_TrackId[22];   //[no_mcshowers]
   vector<string>  *mcshwr_Process;
   Float_t         mcshwr_startX[22];   //[no_mcshowers]
   Float_t         mcshwr_startY[22];   //[no_mcshowers]
   Float_t         mcshwr_startZ[22];   //[no_mcshowers]
   Float_t         mcshwr_endX[22];   //[no_mcshowers]
   Float_t         mcshwr_endY[22];   //[no_mcshowers]
   Float_t         mcshwr_endZ[22];   //[no_mcshowers]
   Float_t         mcshwr_CombEngX[22];   //[no_mcshowers]
   Float_t         mcshwr_CombEngY[22];   //[no_mcshowers]
   Float_t         mcshwr_CombEngZ[22];   //[no_mcshowers]
   Float_t         mcshwr_CombEngPx[22];   //[no_mcshowers]
   Float_t         mcshwr_CombEngPy[22];   //[no_mcshowers]
   Float_t         mcshwr_CombEngPz[22];   //[no_mcshowers]
   Float_t         mcshwr_CombEngE[22];   //[no_mcshowers]
   Float_t         mcshwr_dEdx[22];   //[no_mcshowers]
   Float_t         mcshwr_StartDirX[22];   //[no_mcshowers]
   Float_t         mcshwr_StartDirY[22];   //[no_mcshowers]
   Float_t         mcshwr_StartDirZ[22];   //[no_mcshowers]
   Int_t           mcshwr_isEngDeposited[22];   //[no_mcshowers]
   Int_t           mcshwr_Motherpdg[22];   //[no_mcshowers]
   Int_t           mcshwr_MotherTrkId[22];   //[no_mcshowers]
   vector<string>  *mcshwr_MotherProcess;
   Float_t         mcshwr_MotherstartX[22];   //[no_mcshowers]
   Float_t         mcshwr_MotherstartY[22];   //[no_mcshowers]
   Float_t         mcshwr_MotherstartZ[22];   //[no_mcshowers]
   Float_t         mcshwr_MotherendX[22];   //[no_mcshowers]
   Float_t         mcshwr_MotherendY[22];   //[no_mcshowers]
   Float_t         mcshwr_MotherendZ[22];   //[no_mcshowers]
   Int_t           mcshwr_Ancestorpdg[22];   //[no_mcshowers]
   Int_t           mcshwr_AncesotorTrkId[22];   //[no_mcshowers]
   vector<string>  *mcshwr_AncesotorProcess;
   Float_t         mcshwr_AncestorstartX[22];   //[no_mcshowers]
   Float_t         mcshwr_AncestorstartY[22];   //[no_mcshowers]
   Float_t         mcshwr_AncestorstartZ[22];   //[no_mcshowers]
   Float_t         mcshwr_AncestorendX[22];   //[no_mcshowers]
   Float_t         mcshwr_AncestorendY[22];   //[no_mcshowers]
   Float_t         mcshwr_AncestorendZ[22];   //[no_mcshowers]
   Int_t           no_mctracks;
   Int_t           mctrk_origin[210];   //[no_mctracks]
   Int_t           mctrk_pdg[210];   //[no_mctracks]
   Int_t           mctrk_TrackId[210];   //[no_mctracks]
   vector<string>  *mctrk_Process;
   Float_t         mctrk_startX[210];   //[no_mctracks]
   Float_t         mctrk_startY[210];   //[no_mctracks]
   Float_t         mctrk_startZ[210];   //[no_mctracks]
   Float_t         mctrk_endX[210];   //[no_mctracks]
   Float_t         mctrk_endY[210];   //[no_mctracks]
   Float_t         mctrk_endZ[210];   //[no_mctracks]
   Float_t         mctrk_startX_drifted[210];   //[no_mctracks]
   Float_t         mctrk_startY_drifted[210];   //[no_mctracks]
   Float_t         mctrk_startZ_drifted[210];   //[no_mctracks]
   Float_t         mctrk_endX_drifted[210];   //[no_mctracks]
   Float_t         mctrk_endY_drifted[210];   //[no_mctracks]
   Float_t         mctrk_endZ_drifted[210];   //[no_mctracks]
   Float_t         mctrk_len_drifted[210];   //[no_mctracks]
   Float_t         mctrk_p_drifted[210];   //[no_mctracks]
   Float_t         mctrk_px_drifted[210];   //[no_mctracks]
   Float_t         mctrk_py_drifted[210];   //[no_mctracks]
   Float_t         mctrk_pz_drifted[210];   //[no_mctracks]
   Int_t           mctrk_Motherpdg[210];   //[no_mctracks]
   Int_t           mctrk_MotherTrkId[210];   //[no_mctracks]
   vector<string>  *mctrk_MotherProcess;
   Float_t         mctrk_MotherstartX[210];   //[no_mctracks]
   Float_t         mctrk_MotherstartY[210];   //[no_mctracks]
   Float_t         mctrk_MotherstartZ[210];   //[no_mctracks]
   Float_t         mctrk_MotherendX[210];   //[no_mctracks]
   Float_t         mctrk_MotherendY[210];   //[no_mctracks]
   Float_t         mctrk_MotherendZ[210];   //[no_mctracks]
   Int_t           mctrk_Ancestorpdg[210];   //[no_mctracks]
   Int_t           mctrk_AncesotorTrkId[210];   //[no_mctracks]
   vector<string>  *mctrk_AncesotorProcess;
   Float_t         mctrk_AncestorstartX[210];   //[no_mctracks]
   Float_t         mctrk_AncestorstartY[210];   //[no_mctracks]
   Float_t         mctrk_AncestorstartZ[210];   //[no_mctracks]
   Float_t         mctrk_AncestorendX[210];   //[no_mctracks]
   Float_t         mctrk_AncestorendY[210];   //[no_mctracks]
   Float_t         mctrk_AncestorendZ[210];   //[no_mctracks]
   Short_t         nPFParticles;
   Short_t         pfp_selfID[627];   //[nPFParticles]
   Short_t         pfp_isPrimary[627];   //[nPFParticles]
   Short_t         pfp_numDaughters[627];   //[nPFParticles]
   Short_t         pfp_daughterIDs[627][100];   //[nPFParticles]
   Short_t         pfp_parentID[627];   //[nPFParticles]
   Short_t         pfp_vertexID[627];   //[nPFParticles]
   Short_t         pfp_isShower[627];   //[nPFParticles]
   Short_t         pfp_isTrack[627];   //[nPFParticles]
   Short_t         pfp_trackID[627];   //[nPFParticles]
   Short_t         pfp_showerID[627];   //[nPFParticles]
   Int_t           pfp_pdgCode[627];   //[nPFParticles]
   Short_t         pfp_numClusters[627];   //[nPFParticles]
   Short_t         pfp_clusterIDs[627][100];   //[nPFParticles]
   Short_t         pfp_isNeutrino[627];   //[nPFParticles]
   Short_t         pfp_numNeutrinos;
   Short_t         pfp_neutrinoIDs[10];
   Short_t         nshowers_pandora;
   Short_t         showerID_pandora[282];   //[nshowers_pandora]
   Short_t         shwr_bestplane_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_length_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_theta_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_thetaxz_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_thetayz_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_phi_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_startdcosx_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_startdcosy_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_startdcosz_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_startx_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_starty_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_startz_pandora[282];   //[nshowers_pandora]
   Float_t         shwr_totEng_pandora[282][3];   //[nshowers_pandora]
   Float_t         shwr_dedx_pandora[282][3];   //[nshowers_pandora]
   Float_t         shwr_mipEng_pandora[282][3];   //[nshowers_pandora]
   Short_t         shwr_hasPFParticle_pandora[282];   //[nshowers_pandora]
   Short_t         shwr_PFParticleID_pandora[282];   //[nshowers_pandora]
   ...
   Short_t         nshowers_tcshower;
   Short_t         showerID_tcshower[13];   //[nshowers_tcshower]
   Short_t         shwr_bestplane_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_length_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_theta_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_thetaxz_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_thetayz_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_phi_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_startdcosx_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_startdcosy_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_startdcosz_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_startx_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_starty_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_startz_tcshower[13];   //[nshowers_tcshower]
   Float_t         shwr_totEng_tcshower[13][3];   //[nshowers_tcshower]
   Float_t         shwr_dedx_tcshower[13][3];   //[nshowers_tcshower]
   Float_t         shwr_mipEng_tcshower[13][3];   //[nshowers_tcshower]
   Short_t         shwr_hasPFParticle_tcshower[13];   //[nshowers_tcshower]
   Short_t         shwr_PFParticleID_tcshower[13];   //[nshowers_tcshower]
   Short_t         ntracks_pandora;
   Short_t         trkId_pandora[348];   //[ntracks_pandora]
   Short_t         trkncosmictags_tagger_pandora[348];   //[ntracks_pandora]
   Float_t         trkcosmicscore_tagger_pandora[348];   //[ntracks_pandora]
   Short_t         trkcosmictype_tagger_pandora[348];   //[ntracks_pandora]
   Short_t         trkncosmictags_containmenttagger_pandora[348];   //[ntracks_pandora]
   Float_t         trkcosmicscore_containmenttagger_pandora[348];   //[ntracks_pandora]
   Short_t         trkcosmictype_containmenttagger_pandora[348];   //[ntracks_pandora]
   Short_t         trkncosmictags_flashmatch_pandora[348];   //[ntracks_pandora]
   Float_t         trkcosmicscore_flashmatch_pandora[348];   //[ntracks_pandora]
   Short_t         trkcosmictype_flashmatch_pandora[348];   //[ntracks_pandora]
   Float_t         trkke_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkrange_pandora[348][3];   //[ntracks_pandora]
   Int_t           trkidtruth_pandora[348][3];   //[ntracks_pandora]
   Short_t         trkorigin_pandora[348][3];   //[ntracks_pandora]
   Int_t           trkpdgtruth_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkefftruth_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkpurtruth_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkpitchc_pandora[348][3];   //[ntracks_pandora]
   Short_t         ntrkhits_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkdedx_pandora[348][3][2000];   //[ntracks_pandora]
   Float_t         trkdqdx_pandora[348][3][2000];   //[ntracks_pandora]
   Float_t         trkresrg_pandora[348][3][2000];   //[ntracks_pandora]
   Float_t         trkxyz_pandora[348][3][2000][3];   //[ntracks_pandora]
   Float_t         trkstartx_pandora[348];   //[ntracks_pandora]
   Float_t         trkstarty_pandora[348];   //[ntracks_pandora]
   Float_t         trkstartz_pandora[348];   //[ntracks_pandora]
   Float_t         trkstartd_pandora[348];   //[ntracks_pandora]
   Float_t         trkendx_pandora[348];   //[ntracks_pandora]
   Float_t         trkendy_pandora[348];   //[ntracks_pandora]
   Float_t         trkendz_pandora[348];   //[ntracks_pandora]
   Float_t         trkendd_pandora[348];   //[ntracks_pandora]
   Float_t         trkACpierceT0_pandora[348];   //[ntracks_pandora]
   Float_t         trkflashT0_pandora[348];   //[ntracks_pandora]
   Float_t         trktrueT0_pandora[348];   //[ntracks_pandora]
   Int_t           trkg4id_pandora[348];   //[ntracks_pandora]
   Int_t           trkorig_pandora[348];   //[ntracks_pandora]
   Float_t         trkpurity_pandora[348];   //[ntracks_pandora]
   Float_t         trkcompleteness_pandora[348];   //[ntracks_pandora]
   Float_t         trktheta_pandora[348];   //[ntracks_pandora]
   Float_t         trkphi_pandora[348];   //[ntracks_pandora]
   Float_t         trkstartdcosx_pandora[348];   //[ntracks_pandora]
   Float_t         trkstartdcosy_pandora[348];   //[ntracks_pandora]
   Float_t         trkstartdcosz_pandora[348];   //[ntracks_pandora]
   Float_t         trkenddcosx_pandora[348];   //[ntracks_pandora]
   Float_t         trkenddcosy_pandora[348];   //[ntracks_pandora]
   Float_t         trkenddcosz_pandora[348];   //[ntracks_pandora]
   Float_t         trkthetaxz_pandora[348];   //[ntracks_pandora]
   Float_t         trkthetayz_pandora[348];   //[ntracks_pandora]
   Float_t         trkmom_pandora[348];   //[ntracks_pandora]
   Float_t         trkmomrange_pandora[348];   //[ntracks_pandora]
   Float_t         trkmommschi2_pandora[348];   //[ntracks_pandora]
   Float_t         trkmommsllhd_pandora[348];   //[ntracks_pandora]
   Float_t         trkmcsfwdmom_pandora[348];   //[ntracks_pandora]
   Float_t         trkmcsfwdll_pandora[348];   //[ntracks_pandora]
   Float_t         trkmcsfwderr_pandora[348];   //[ntracks_pandora]
   Float_t         trkmcsbwdmom_pandora[348];   //[ntracks_pandora]
   Float_t         trkmcsbwdll_pandora[348];   //[ntracks_pandora]
   Float_t         trkmcsbwderr_pandora[348];   //[ntracks_pandora]
   Float_t         trklen_pandora[348];   //[ntracks_pandora]
   Short_t         trksvtxid_pandora[348];   //[ntracks_pandora]
   Short_t         trkevtxid_pandora[348];   //[ntracks_pandora]
   Int_t           trkntraj_pandora[348];   //[ntracks_pandora]
   Int_t           trkpidpdg_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkpidchi_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkpidchipr_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkpidchika_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkpidchipi_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkpidchimu_pandora[348][3];   //[ntracks_pandora]
   Float_t         trkpidpida_pandora[348][3];   //[ntracks_pandora]
   Short_t         trkpidbestplane_pandora[348];   //[ntracks_pandora]
   Short_t         trkhasPFParticle_pandora[348];   //[ntracks_pandora]
   Short_t         trkPFParticleID_pandora[348];   //[ntracks_pandora]
   Short_t         ntracks_pandoraKalmanTrack;
   Short_t         trkId_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_tagger_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_tagger_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_tagger_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_containmenttagger_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_containmenttagger_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_containmenttagger_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_flashmatch_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_flashmatch_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_flashmatch_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkke_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkrange_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkidtruth_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkorigin_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkpdgtruth_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkefftruth_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpurtruth_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpitchc_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         ntrkhits_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkdedx_pandoraKalmanTrack[317][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkdqdx_pandoraKalmanTrack[317][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkresrg_pandoraKalmanTrack[317][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkxyz_pandoraKalmanTrack[317][3][2000][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartx_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstarty_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartz_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartd_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendx_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendy_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendz_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendd_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkACpierceT0_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkflashT0_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trktrueT0_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkg4id_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkorig_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpurity_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcompleteness_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trktheta_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkphi_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosx_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosy_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosz_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosx_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosy_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosz_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkthetaxz_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkthetayz_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmom_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmomrange_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmommschi2_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmommsllhd_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwdmom_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwdll_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwderr_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwdmom_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwdll_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwderr_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Float_t         trklen_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         trksvtxid_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkevtxid_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkntraj_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkpidpdg_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchi_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchipr_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchika_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchipi_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchimu_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidpida_pandoraKalmanTrack[317][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkpidbestplane_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkhasPFParticle_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkPFParticleID_pandoraKalmanTrack[317];   //[ntracks_pandoraKalmanTrack]
   Short_t         ntracks_pandoraKalmanShower;
   Short_t         trkId_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         trkncosmictags_tagger_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcosmicscore_tagger_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         trkcosmictype_tagger_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         trkncosmictags_containmenttagger_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcosmicscore_containmenttagger_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         trkcosmictype_containmenttagger_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         trkncosmictags_flashmatch_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcosmicscore_flashmatch_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         trkcosmictype_flashmatch_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkke_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkrange_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Int_t           trkidtruth_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Short_t         trkorigin_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Int_t           trkpdgtruth_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkefftruth_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpurtruth_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpitchc_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Short_t         ntrkhits_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkdedx_pandoraKalmanShower[189][3][2000];   //[ntracks_pandoraKalmanShower]
   Float_t         trkdqdx_pandoraKalmanShower[189][3][2000];   //[ntracks_pandoraKalmanShower]
   Float_t         trkresrg_pandoraKalmanShower[189][3][2000];   //[ntracks_pandoraKalmanShower]
   Float_t         trkxyz_pandoraKalmanShower[189][3][2000][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartx_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstarty_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartz_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartd_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendx_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendy_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendz_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendd_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkACpierceT0_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkflashT0_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trktrueT0_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Int_t           trkg4id_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Int_t           trkorig_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpurity_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcompleteness_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trktheta_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkphi_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartdcosx_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartdcosy_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartdcosz_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkenddcosx_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkenddcosy_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkenddcosz_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkthetaxz_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkthetayz_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmom_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmomrange_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmommschi2_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmommsllhd_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsfwdmom_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsfwdll_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsfwderr_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsbwdmom_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsbwdll_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsbwderr_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Float_t         trklen_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         trksvtxid_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         trkevtxid_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Int_t           trkntraj_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Int_t           trkpidpdg_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchi_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchipr_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchika_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchipi_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchimu_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidpida_pandoraKalmanShower[189][3];   //[ntracks_pandoraKalmanShower]
   Short_t         trkpidbestplane_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         trkhasPFParticle_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         trkPFParticleID_pandoraKalmanShower[189];   //[ntracks_pandoraKalmanShower]
   Short_t         nvtx_pandora;
   Short_t         vtxId_pandora[604];   //[nvtx_pandora]
   Float_t         vtxx_pandora[604];   //[nvtx_pandora]
   Float_t         vtxy_pandora[604];   //[nvtx_pandora]
   Float_t         vtxz_pandora[604];   //[nvtx_pandora]
   Short_t         vtxhasPFParticle_pandora[604];   //[nvtx_pandora]
   Short_t         vtxPFParticleID_pandora[604];   //[nvtx_pandora]
   Short_t         nvtx_trajcluster;
   Short_t         vtxId_trajcluster[433];   //[nvtx_trajcluster]
   Float_t         vtxx_trajcluster[433];   //[nvtx_trajcluster]
   Float_t         vtxy_trajcluster[433];   //[nvtx_trajcluster]
   Float_t         vtxz_trajcluster[433];   //[nvtx_trajcluster]
   Short_t         vtxhasPFParticle_trajcluster[433];   //[nvtx_trajcluster]
   Short_t         vtxPFParticleID_trajcluster[433];   //[nvtx_trajcluster]
   ...
   Float_t         flsTime_simpleFlashCosmic[51];   //[nfls_simpleFlashCosmic]
   Float_t         flsPe_simpleFlashCosmic[51];   //[nfls_simpleFlashCosmic]
   Double_t        flsPePerOpDet_simpleFlashCosmic[51][32];   //[nfls_simpleFlashCosmic]
   Float_t         flsXcenter_simpleFlashCosmic[51];   //[nfls_simpleFlashCosmic]
   Float_t         flsYcenter_simpleFlashCosmic[51];   //[nfls_simpleFlashCosmic]
   Float_t         flsZcenter_simpleFlashCosmic[51];   //[nfls_simpleFlashCosmic]
   Float_t         flsYwidth_simpleFlashCosmic[51];   //[nfls_simpleFlashCosmic]
   Float_t         flsZwidth_simpleFlashCosmic[51];   //[nfls_simpleFlashCosmic]
   Float_t         flsTwidth_simpleFlashCosmic[51];   //[nfls_simpleFlashCosmic]
   ...
   TBranch        *b_nshowers_tcshower;   //!
   TBranch        *b_showerID_tcshower;   //!
   TBranch        *b_shwr_bestplane_tcshower;   //!
   TBranch        *b_shwr_length_tcshower;   //!
   TBranch        *b_shwr_theta_tcshower;   //!
   TBranch        *b_shwr_thetaxz_tcshower;   //!
   TBranch        *b_shwr_thetayz_tcshower;   //!
   TBranch        *b_shwr_phi_tcshower;   //!
   TBranch        *b_shwr_startdcosx_tcshower;   //!
   TBranch        *b_shwr_startdcosy_tcshower;   //!
   TBranch        *b_shwr_startdcosz_tcshower;   //!
   TBranch        *b_shwr_startx_tcshower;   //!
   TBranch        *b_shwr_starty_tcshower;   //!
   TBranch        *b_shwr_startz_tcshower;   //!
   TBranch        *b_shwr_totEng_tcshower;   //!
   TBranch        *b_shwr_dedx_tcshower;   //!
   TBranch        *b_shwr_mipEng_tcshower;   //!
   TBranch        *b_shwr_hasPFParticle_tcshower;   //!
   TBranch        *b_shwr_PFParticleID_tcshower;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../MCC9_CCCoh_New_Sample.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../MCC9_CCCoh_New_Sample.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../MCC9_CCCoh_New_Sample.root:/analysistree");
...
void NewAnalysisCCCoh::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("nshowers_tcshower", &nshowers_tcshower, &b_nshowers_tcshower);
   fChain->SetBranchAddress("showerID_tcshower", showerID_tcshower, &b_showerID_tcshower);
   fChain->SetBranchAddress("shwr_bestplane_tcshower", shwr_bestplane_tcshower, &b_shwr_bestplane_tcshower);
   fChain->SetBranchAddress("shwr_length_tcshower", shwr_length_tcshower, &b_shwr_length_tcshower);
   fChain->SetBranchAddress("shwr_theta_tcshower", shwr_theta_tcshower, &b_shwr_theta_tcshower);
   fChain->SetBranchAddress("shwr_thetaxz_tcshower", shwr_thetaxz_tcshower, &b_shwr_thetaxz_tcshower);
   fChain->SetBranchAddress("shwr_thetayz_tcshower", shwr_thetayz_tcshower, &b_shwr_thetayz_tcshower);
   fChain->SetBranchAddress("shwr_phi_tcshower", shwr_phi_tcshower, &b_shwr_phi_tcshower);
   fChain->SetBranchAddress("shwr_startdcosx_tcshower", shwr_startdcosx_tcshower, &b_shwr_startdcosx_tcshower);
   fChain->SetBranchAddress("shwr_startdcosy_tcshower", shwr_startdcosy_tcshower, &b_shwr_startdcosy_tcshower);
   fChain->SetBranchAddress("shwr_startdcosz_tcshower", shwr_startdcosz_tcshower, &b_shwr_startdcosz_tcshower);
   fChain->SetBranchAddress("shwr_startx_tcshower", shwr_startx_tcshower, &b_shwr_startx_tcshower);
   fChain->SetBranchAddress("shwr_starty_tcshower", shwr_starty_tcshower, &b_shwr_starty_tcshower);
   fChain->SetBranchAddress("shwr_startz_tcshower", shwr_startz_tcshower, &b_shwr_startz_tcshower);
   fChain->SetBranchAddress("shwr_totEng_tcshower", shwr_totEng_tcshower, &b_shwr_totEng_tcshower);
   fChain->SetBranchAddress("shwr_dedx_tcshower", shwr_dedx_tcshower, &b_shwr_dedx_tcshower);
   fChain->SetBranchAddress("shwr_mipEng_tcshower", shwr_mipEng_tcshower, &b_shwr_mipEng_tcshower);
   fChain->SetBranchAddress("shwr_hasPFParticle_tcshower", shwr_hasPFParticle_tcshower, &b_shwr_hasPFParticle_tcshower);
   fChain->SetBranchAddress("shwr_PFParticleID_tcshower", shwr_PFParticleID_tcshower, &b_shwr_PFParticleID_tcshower);
