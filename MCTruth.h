...
// Wed Jan 30 14:55:13 2019 by ROOT version 6.12/06
// from TTree anatree/analysis tree
// found on file: anatree_test.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Short_t         hit_plane[22953];   //[no_hits_stored]
   Short_t         hit_wire[22953];   //[no_hits_stored]
   Short_t         hit_channel[22953];   //[no_hits_stored]
   Float_t         hit_peakT[22953];   //[no_hits_stored]
   Float_t         hit_charge[22953];   //[no_hits_stored]
   Float_t         hit_ph[22953];   //[no_hits_stored]
   Float_t         hit_startT[22953];   //[no_hits_stored]
   Float_t         hit_endT[22953];   //[no_hits_stored]
   Float_t         hit_rms[22953];   //[no_hits_stored]
   Float_t         hit_trueX[22953];   //[no_hits_stored]
   Float_t         hit_goodnessOfFit[22953];   //[no_hits_stored]
   Short_t         hit_multiplicity[22953];   //[no_hits_stored]
   Short_t         hit_trkid[22953];   //[no_hits_stored]
   Short_t         hit_trkKey[22953];   //[no_hits_stored]
   Short_t         hit_clusterid[22953];   //[no_hits_stored]
   Short_t         hit_clusterKey[22953];   //[no_hits_stored]
   Float_t         hit_nelec[22953];   //[no_hits_stored]
   Float_t         hit_energy[22953];   //[no_hits_stored]
   Short_t         nclusters;
   ...
   Int_t           genie_primaries_pdg[16];   //[genie_no_primaries]
   Float_t         genie_Eng[16];   //[genie_no_primaries]
   Float_t         genie_Px[16];   //[genie_no_primaries]
   Float_t         genie_Py[16];   //[genie_no_primaries]
   Float_t         genie_Pz[16];   //[genie_no_primaries]
   Float_t         genie_P[16];   //[genie_no_primaries]
   Int_t           genie_status_code[16];   //[genie_no_primaries]
   Float_t         genie_mass[16];   //[genie_no_primaries]
   Int_t           genie_trackID[16];   //[genie_no_primaries]
   Int_t           genie_ND[16];   //[genie_no_primaries]
   Int_t           genie_mother[16];   //[genie_no_primaries]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           geant_list_size_in_tpcAV;
   Int_t           pdg[135];   //[geant_list_size]
   Int_t           status[135];   //[geant_list_size]
   Float_t         Mass[135];   //[geant_list_size]
   Float_t         Eng[135];   //[geant_list_size]
   Float_t         EndE[135];   //[geant_list_size]
   Float_t         Px[135];   //[geant_list_size]
   Float_t         Py[135];   //[geant_list_size]
   Float_t         Pz[135];   //[geant_list_size]
   Float_t         P[135];   //[geant_list_size]
   Float_t         StartPointx[135];   //[geant_list_size]
   Float_t         StartPointy[135];   //[geant_list_size]
   Float_t         StartPointz[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz[135];   //[geant_list_size]
   Float_t         StartT[135];   //[geant_list_size]
   Float_t         EndPointx[135];   //[geant_list_size]
   Float_t         EndPointy[135];   //[geant_list_size]
   Float_t         EndPointz[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz[135];   //[geant_list_size]
   Float_t         EndT[135];   //[geant_list_size]
   Float_t         theta[135];   //[geant_list_size]
   Float_t         phi[135];   //[geant_list_size]
   Float_t         theta_xz[135];   //[geant_list_size]
   Float_t         theta_yz[135];   //[geant_list_size]
   Float_t         pathlen[135];   //[geant_list_size]
   Int_t           inTPCActive[135];   //[geant_list_size]
   Float_t         StartPointx_tpcAV[135];   //[geant_list_size]
   Float_t         StartPointy_tpcAV[135];   //[geant_list_size]
   Float_t         StartPointz_tpcAV[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx_tpcAV[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy_tpcAV[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz_tpcAV[135];   //[geant_list_size]
   Float_t         StartT_tpcAV[135];   //[geant_list_size]
   Float_t         StartE_tpcAV[135];   //[geant_list_size]
   Float_t         StartP_tpcAV[135];   //[geant_list_size]
   Float_t         StartPx_tpcAV[135];   //[geant_list_size]
   Float_t         StartPy_tpcAV[135];   //[geant_list_size]
   Float_t         StartPz_tpcAV[135];   //[geant_list_size]
   Float_t         EndPointx_tpcAV[135];   //[geant_list_size]
   Float_t         EndPointy_tpcAV[135];   //[geant_list_size]
   Float_t         EndPointz_tpcAV[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx_tpcAV[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy_tpcAV[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz_tpcAV[135];   //[geant_list_size]
   Float_t         EndT_tpcAV[135];   //[geant_list_size]
   Float_t         EndE_tpcAV[135];   //[geant_list_size]
   Float_t         EndP_tpcAV[135];   //[geant_list_size]
   Float_t         EndPx_tpcAV[135];   //[geant_list_size]
   Float_t         EndPy_tpcAV[135];   //[geant_list_size]
   Float_t         EndPz_tpcAV[135];   //[geant_list_size]
   Float_t         pathlen_drifted[135];   //[geant_list_size]
   Int_t           inTPCDrifted[135];   //[geant_list_size]
   Float_t         StartPointx_drifted[135];   //[geant_list_size]
   Float_t         StartPointy_drifted[135];   //[geant_list_size]
   Float_t         StartPointz_drifted[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointx_drifted[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointy_drifted[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_StartPointz_drifted[135];   //[geant_list_size]
   Float_t         StartT_drifted[135];   //[geant_list_size]
   Float_t         StartE_drifted[135];   //[geant_list_size]
   Float_t         StartP_drifted[135];   //[geant_list_size]
   Float_t         StartPx_drifted[135];   //[geant_list_size]
   Float_t         StartPy_drifted[135];   //[geant_list_size]
   Float_t         StartPz_drifted[135];   //[geant_list_size]
   Float_t         EndPointx_drifted[135];   //[geant_list_size]
   Float_t         EndPointy_drifted[135];   //[geant_list_size]
   Float_t         EndPointz_drifted[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointx_drifted[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointy_drifted[135];   //[geant_list_size]
   Float_t         sp_charge_corrected_EndPointz_drifted[135];   //[geant_list_size]
   Float_t         EndT_drifted[135];   //[geant_list_size]
   Float_t         EndE_drifted[135];   //[geant_list_size]
   Float_t         EndP_drifted[135];   //[geant_list_size]
   Float_t         EndPx_drifted[135];   //[geant_list_size]
   Float_t         EndPy_drifted[135];   //[geant_list_size]
   Float_t         EndPz_drifted[135];   //[geant_list_size]
   Int_t           NumberDaughters[135];   //[geant_list_size]
   Int_t           Mother[135];   //[geant_list_size]
   Int_t           TrackId[135];   //[geant_list_size]
   Int_t           MergedId[135];   //[geant_list_size]
   Int_t           origin[135];   //[geant_list_size]
   Int_t           MCTruthIndex[135];   //[geant_list_size]
   Int_t           process_primary[135];   //[geant_list_size]
   vector<string>  *processname;
   Int_t           NTrTrajPts[9];   //[no_primaries]
   Double_t        TrueTraj_X[9][5000];   //[no_primaries]
   Double_t        TrueTraj_Y[9][5000];   //[no_primaries]
   Double_t        TrueTraj_Z[9][5000];   //[no_primaries]
   Double_t        TrueTraj_E[9][5000];   //[no_primaries]
   Int_t           no_mcshowers;
   Int_t           mcshwr_origin[3];   //[no_mcshowers]
   Int_t           mcshwr_pdg[3];   //[no_mcshowers]
   Int_t           mcshwr_TrackId[3];   //[no_mcshowers]
   vector<string>  *mcshwr_Process;
   Float_t         mcshwr_startX[3];   //[no_mcshowers]
   Float_t         mcshwr_startY[3];   //[no_mcshowers]
   Float_t         mcshwr_startZ[3];   //[no_mcshowers]
   Float_t         mcshwr_endX[3];   //[no_mcshowers]
   Float_t         mcshwr_endY[3];   //[no_mcshowers]
   Float_t         mcshwr_endZ[3];   //[no_mcshowers]
   Float_t         mcshwr_CombEngX[3];   //[no_mcshowers]
   Float_t         mcshwr_CombEngY[3];   //[no_mcshowers]
   Float_t         mcshwr_CombEngZ[3];   //[no_mcshowers]
   Float_t         mcshwr_CombEngPx[3];   //[no_mcshowers]
   Float_t         mcshwr_CombEngPy[3];   //[no_mcshowers]
   Float_t         mcshwr_CombEngPz[3];   //[no_mcshowers]
   Float_t         mcshwr_CombEngE[3];   //[no_mcshowers]
   Float_t         mcshwr_dEdx[3];   //[no_mcshowers]
   Float_t         mcshwr_StartDirX[3];   //[no_mcshowers]
   Float_t         mcshwr_StartDirY[3];   //[no_mcshowers]
   Float_t         mcshwr_StartDirZ[3];   //[no_mcshowers]
   Int_t           mcshwr_isEngDeposited[3];   //[no_mcshowers]
   Int_t           mcshwr_Motherpdg[3];   //[no_mcshowers]
   Int_t           mcshwr_MotherTrkId[3];   //[no_mcshowers]
   vector<string>  *mcshwr_MotherProcess;
   Float_t         mcshwr_MotherstartX[3];   //[no_mcshowers]
   Float_t         mcshwr_MotherstartY[3];   //[no_mcshowers]
   Float_t         mcshwr_MotherstartZ[3];   //[no_mcshowers]
   Float_t         mcshwr_MotherendX[3];   //[no_mcshowers]
   Float_t         mcshwr_MotherendY[3];   //[no_mcshowers]
   Float_t         mcshwr_MotherendZ[3];   //[no_mcshowers]
   Int_t           mcshwr_Ancestorpdg[3];   //[no_mcshowers]
   Int_t           mcshwr_AncesotorTrkId[3];   //[no_mcshowers]
   vector<string>  *mcshwr_AncesotorProcess;
   Float_t         mcshwr_AncestorstartX[3];   //[no_mcshowers]
   Float_t         mcshwr_AncestorstartY[3];   //[no_mcshowers]
   Float_t         mcshwr_AncestorstartZ[3];   //[no_mcshowers]
   Float_t         mcshwr_AncestorendX[3];   //[no_mcshowers]
   Float_t         mcshwr_AncestorendY[3];   //[no_mcshowers]
   Float_t         mcshwr_AncestorendZ[3];   //[no_mcshowers]
   Int_t           no_mctracks;
   Int_t           mctrk_origin[28];   //[no_mctracks]
   Int_t           mctrk_pdg[28];   //[no_mctracks]
   Int_t           mctrk_TrackId[28];   //[no_mctracks]
   vector<string>  *mctrk_Process;
   Float_t         mctrk_startX[28];   //[no_mctracks]
   Float_t         mctrk_startY[28];   //[no_mctracks]
   Float_t         mctrk_startZ[28];   //[no_mctracks]
   Float_t         mctrk_endX[28];   //[no_mctracks]
   Float_t         mctrk_endY[28];   //[no_mctracks]
   Float_t         mctrk_endZ[28];   //[no_mctracks]
   Float_t         mctrk_startX_drifted[28];   //[no_mctracks]
   Float_t         mctrk_startY_drifted[28];   //[no_mctracks]
   Float_t         mctrk_startZ_drifted[28];   //[no_mctracks]
   Float_t         mctrk_endX_drifted[28];   //[no_mctracks]
   Float_t         mctrk_endY_drifted[28];   //[no_mctracks]
   Float_t         mctrk_endZ_drifted[28];   //[no_mctracks]
   Float_t         mctrk_len_drifted[28];   //[no_mctracks]
   Float_t         mctrk_p_drifted[28];   //[no_mctracks]
   Float_t         mctrk_px_drifted[28];   //[no_mctracks]
   Float_t         mctrk_py_drifted[28];   //[no_mctracks]
   Float_t         mctrk_pz_drifted[28];   //[no_mctracks]
   Int_t           mctrk_Motherpdg[28];   //[no_mctracks]
   Int_t           mctrk_MotherTrkId[28];   //[no_mctracks]
   vector<string>  *mctrk_MotherProcess;
   Float_t         mctrk_MotherstartX[28];   //[no_mctracks]
   Float_t         mctrk_MotherstartY[28];   //[no_mctracks]
   Float_t         mctrk_MotherstartZ[28];   //[no_mctracks]
   Float_t         mctrk_MotherendX[28];   //[no_mctracks]
   Float_t         mctrk_MotherendY[28];   //[no_mctracks]
   Float_t         mctrk_MotherendZ[28];   //[no_mctracks]
   Int_t           mctrk_Ancestorpdg[28];   //[no_mctracks]
   Int_t           mctrk_AncesotorTrkId[28];   //[no_mctracks]
   vector<string>  *mctrk_AncesotorProcess;
   Float_t         mctrk_AncestorstartX[28];   //[no_mctracks]
   Float_t         mctrk_AncestorstartY[28];   //[no_mctracks]
   Float_t         mctrk_AncestorstartZ[28];   //[no_mctracks]
   Float_t         mctrk_AncestorendX[28];   //[no_mctracks]
   Float_t         mctrk_AncestorendY[28];   //[no_mctracks]
   Float_t         mctrk_AncestorendZ[28];   //[no_mctracks]
   Short_t         nPFParticles;
   Short_t         pfp_selfID[164];   //[nPFParticles]
   Short_t         pfp_isPrimary[164];   //[nPFParticles]
   Short_t         pfp_numDaughters[164];   //[nPFParticles]
   Short_t         pfp_daughterIDs[164][100];   //[nPFParticles]
   Short_t         pfp_parentID[164];   //[nPFParticles]
   Short_t         pfp_vertexID[164];   //[nPFParticles]
   Short_t         pfp_isShower[164];   //[nPFParticles]
   Short_t         pfp_isTrack[164];   //[nPFParticles]
   Short_t         pfp_trackID[164];   //[nPFParticles]
   Short_t         pfp_showerID[164];   //[nPFParticles]
   Int_t           pfp_pdgCode[164];   //[nPFParticles]
   Short_t         pfp_numClusters[164];   //[nPFParticles]
   Short_t         pfp_clusterIDs[164][100];   //[nPFParticles]
   Short_t         pfp_isNeutrino[164];   //[nPFParticles]
   Short_t         pfp_numNeutrinos;
   Short_t         pfp_neutrinoIDs[10];
   Short_t         nshowers_pandora;
   Short_t         showerID_pandora[123];   //[nshowers_pandora]
   Short_t         shwr_bestplane_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_length_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_theta_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_thetaxz_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_thetayz_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_phi_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_startdcosx_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_startdcosy_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_startdcosz_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_startx_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_starty_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_startz_pandora[123];   //[nshowers_pandora]
   Float_t         shwr_totEng_pandora[123][3];   //[nshowers_pandora]
   Float_t         shwr_dedx_pandora[123][3];   //[nshowers_pandora]
   Float_t         shwr_mipEng_pandora[123][3];   //[nshowers_pandora]
   Short_t         shwr_hasPFParticle_pandora[123];   //[nshowers_pandora]
   Short_t         shwr_PFParticleID_pandora[123];   //[nshowers_pandora]
   ...
   Short_t         trkId_pandora[45];   //[ntracks_pandora]
   Short_t         trkncosmictags_tagger_pandora[45];   //[ntracks_pandora]
   Float_t         trkcosmicscore_tagger_pandora[45];   //[ntracks_pandora]
   Short_t         trkcosmictype_tagger_pandora[45];   //[ntracks_pandora]
   Short_t         trkncosmictags_containmenttagger_pandora[45];   //[ntracks_pandora]
   Float_t         trkcosmicscore_containmenttagger_pandora[45];   //[ntracks_pandora]
   Short_t         trkcosmictype_containmenttagger_pandora[45];   //[ntracks_pandora]
   Short_t         trkncosmictags_flashmatch_pandora[45];   //[ntracks_pandora]
   Float_t         trkcosmicscore_flashmatch_pandora[45];   //[ntracks_pandora]
   Short_t         trkcosmictype_flashmatch_pandora[45];   //[ntracks_pandora]
   Float_t         trkke_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkrange_pandora[45][3];   //[ntracks_pandora]
   Int_t           trkidtruth_pandora[45][3];   //[ntracks_pandora]
   Short_t         trkorigin_pandora[45][3];   //[ntracks_pandora]
   Int_t           trkpdgtruth_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkefftruth_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkpurtruth_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkpitchc_pandora[45][3];   //[ntracks_pandora]
   Short_t         ntrkhits_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkdedx_pandora[45][3][2000];   //[ntracks_pandora]
   Float_t         trkdqdx_pandora[45][3][2000];   //[ntracks_pandora]
   Float_t         trkresrg_pandora[45][3][2000];   //[ntracks_pandora]
   Float_t         trkxyz_pandora[45][3][2000][3];   //[ntracks_pandora]
   Float_t         trkstartx_pandora[45];   //[ntracks_pandora]
   Float_t         trkstarty_pandora[45];   //[ntracks_pandora]
   Float_t         trkstartz_pandora[45];   //[ntracks_pandora]
   Float_t         trkstartd_pandora[45];   //[ntracks_pandora]
   Float_t         trkendx_pandora[45];   //[ntracks_pandora]
   Float_t         trkendy_pandora[45];   //[ntracks_pandora]
   Float_t         trkendz_pandora[45];   //[ntracks_pandora]
   Float_t         trkendd_pandora[45];   //[ntracks_pandora]
   Float_t         trkACpierceT0_pandora[45];   //[ntracks_pandora]
   Float_t         trkflashT0_pandora[45];   //[ntracks_pandora]
   Float_t         trktrueT0_pandora[45];   //[ntracks_pandora]
   Int_t           trkg4id_pandora[45];   //[ntracks_pandora]
   Int_t           trkorig_pandora[45];   //[ntracks_pandora]
   Float_t         trkpurity_pandora[45];   //[ntracks_pandora]
   Float_t         trkcompleteness_pandora[45];   //[ntracks_pandora]
   Float_t         trktheta_pandora[45];   //[ntracks_pandora]
   Float_t         trkphi_pandora[45];   //[ntracks_pandora]
   Float_t         trkstartdcosx_pandora[45];   //[ntracks_pandora]
   Float_t         trkstartdcosy_pandora[45];   //[ntracks_pandora]
   Float_t         trkstartdcosz_pandora[45];   //[ntracks_pandora]
   Float_t         trkenddcosx_pandora[45];   //[ntracks_pandora]
   Float_t         trkenddcosy_pandora[45];   //[ntracks_pandora]
   Float_t         trkenddcosz_pandora[45];   //[ntracks_pandora]
   Float_t         trkthetaxz_pandora[45];   //[ntracks_pandora]
   Float_t         trkthetayz_pandora[45];   //[ntracks_pandora]
   Float_t         trkmom_pandora[45];   //[ntracks_pandora]
   Float_t         trkmomrange_pandora[45];   //[ntracks_pandora]
   Float_t         trkmommschi2_pandora[45];   //[ntracks_pandora]
   Float_t         trkmommsllhd_pandora[45];   //[ntracks_pandora]
   Float_t         trkmcsfwdmom_pandora[45];   //[ntracks_pandora]
   Float_t         trkmcsfwdll_pandora[45];   //[ntracks_pandora]
   Float_t         trkmcsfwderr_pandora[45];   //[ntracks_pandora]
   Float_t         trkmcsbwdmom_pandora[45];   //[ntracks_pandora]
   Float_t         trkmcsbwdll_pandora[45];   //[ntracks_pandora]
   Float_t         trkmcsbwderr_pandora[45];   //[ntracks_pandora]
   Float_t         trklen_pandora[45];   //[ntracks_pandora]
   Short_t         trksvtxid_pandora[45];   //[ntracks_pandora]
   Short_t         trkevtxid_pandora[45];   //[ntracks_pandora]
   Int_t           trkntraj_pandora[45];   //[ntracks_pandora]
   Int_t           trkpidpdg_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkpidchi_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkpidchipr_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkpidchika_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkpidchipi_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkpidchimu_pandora[45][3];   //[ntracks_pandora]
   Float_t         trkpidpida_pandora[45][3];   //[ntracks_pandora]
   Short_t         trkpidbestplane_pandora[45];   //[ntracks_pandora]
   Short_t         trkhasPFParticle_pandora[45];   //[ntracks_pandora]
   Short_t         trkPFParticleID_pandora[45];   //[ntracks_pandora]
   Short_t         ntracks_pandoraKalmanTrack;
   Short_t         trkId_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_tagger_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_tagger_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_tagger_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_containmenttagger_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_containmenttagger_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_containmenttagger_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkncosmictags_flashmatch_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcosmicscore_flashmatch_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkcosmictype_flashmatch_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkke_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkrange_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkidtruth_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkorigin_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkpdgtruth_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkefftruth_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpurtruth_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpitchc_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         ntrkhits_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkdedx_pandoraKalmanTrack[45][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkdqdx_pandoraKalmanTrack[45][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkresrg_pandoraKalmanTrack[45][3][2000];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkxyz_pandoraKalmanTrack[45][3][2000][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartx_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstarty_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartz_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartd_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendx_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendy_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendz_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkendd_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkACpierceT0_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkflashT0_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trktrueT0_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkg4id_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkorig_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpurity_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkcompleteness_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trktheta_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkphi_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosx_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosy_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkstartdcosz_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosx_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosy_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkenddcosz_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkthetaxz_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkthetayz_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmom_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmomrange_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmommschi2_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmommsllhd_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwdmom_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwdll_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsfwderr_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwdmom_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwdll_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkmcsbwderr_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Float_t         trklen_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         trksvtxid_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkevtxid_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkntraj_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Int_t           trkpidpdg_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchi_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchipr_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchika_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchipi_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidchimu_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Float_t         trkpidpida_pandoraKalmanTrack[45][3];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkpidbestplane_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkhasPFParticle_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         trkPFParticleID_pandoraKalmanTrack[45];   //[ntracks_pandoraKalmanTrack]
   Short_t         ntracks_pmtrack;
   Short_t         trkId_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_tagger_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_tagger_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_tagger_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_containmenttagger_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_containmenttagger_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_containmenttagger_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_flashmatch_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_flashmatch_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_flashmatch_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkke_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkrange_pmtrack[129][3];   //[ntracks_pmtrack]
   Int_t           trkidtruth_pmtrack[129][3];   //[ntracks_pmtrack]
   Short_t         trkorigin_pmtrack[129][3];   //[ntracks_pmtrack]
   Int_t           trkpdgtruth_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkefftruth_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkpurtruth_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkpitchc_pmtrack[129][3];   //[ntracks_pmtrack]
   Short_t         ntrkhits_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkdedx_pmtrack[129][3][2000];   //[ntracks_pmtrack]
   Float_t         trkdqdx_pmtrack[129][3][2000];   //[ntracks_pmtrack]
   Float_t         trkresrg_pmtrack[129][3][2000];   //[ntracks_pmtrack]
   Float_t         trkxyz_pmtrack[129][3][2000][3];   //[ntracks_pmtrack]
   Float_t         trkstartx_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkstarty_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkstartz_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkstartd_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkendx_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkendy_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkendz_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkendd_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkACpierceT0_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkflashT0_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trktrueT0_pmtrack[129];   //[ntracks_pmtrack]
   Int_t           trkg4id_pmtrack[129];   //[ntracks_pmtrack]
   Int_t           trkorig_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkpurity_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkcompleteness_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trktheta_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkphi_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkstartdcosx_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkstartdcosy_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkstartdcosz_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkenddcosx_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkenddcosy_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkenddcosz_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkthetaxz_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkthetayz_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkmom_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkmomrange_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkmommschi2_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkmommsllhd_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkmcsfwdmom_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkmcsfwdll_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkmcsfwderr_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkmcsbwdmom_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkmcsbwdll_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trkmcsbwderr_pmtrack[129];   //[ntracks_pmtrack]
   Float_t         trklen_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         trksvtxid_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         trkevtxid_pmtrack[129];   //[ntracks_pmtrack]
   Int_t           trkntraj_pmtrack[129];   //[ntracks_pmtrack]
   Int_t           trkpidpdg_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkpidchi_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkpidchipr_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkpidchika_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkpidchipi_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkpidchimu_pmtrack[129][3];   //[ntracks_pmtrack]
   Float_t         trkpidpida_pmtrack[129][3];   //[ntracks_pmtrack]
   Short_t         trkpidbestplane_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         trkhasPFParticle_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         trkPFParticleID_pmtrack[129];   //[ntracks_pmtrack]
   Short_t         ntracks_pandoraKalmanShower;
   Short_t         trkId_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         trkncosmictags_tagger_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcosmicscore_tagger_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         trkcosmictype_tagger_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         trkncosmictags_containmenttagger_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcosmicscore_containmenttagger_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         trkcosmictype_containmenttagger_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         trkncosmictags_flashmatch_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcosmicscore_flashmatch_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         trkcosmictype_flashmatch_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkke_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkrange_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Int_t           trkidtruth_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Short_t         trkorigin_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Int_t           trkpdgtruth_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkefftruth_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpurtruth_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpitchc_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Short_t         ntrkhits_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkdedx_pandoraKalmanShower[92][3][2000];   //[ntracks_pandoraKalmanShower]
   Float_t         trkdqdx_pandoraKalmanShower[92][3][2000];   //[ntracks_pandoraKalmanShower]
   Float_t         trkresrg_pandoraKalmanShower[92][3][2000];   //[ntracks_pandoraKalmanShower]
   Float_t         trkxyz_pandoraKalmanShower[92][3][2000][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartx_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstarty_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartz_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartd_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendx_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendy_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendz_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkendd_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkACpierceT0_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkflashT0_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trktrueT0_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Int_t           trkg4id_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Int_t           trkorig_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpurity_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkcompleteness_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trktheta_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkphi_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartdcosx_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartdcosy_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkstartdcosz_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkenddcosx_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkenddcosy_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkenddcosz_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkthetaxz_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkthetayz_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmom_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmomrange_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmommschi2_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmommsllhd_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsfwdmom_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsfwdll_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsfwderr_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsbwdmom_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsbwdll_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trkmcsbwderr_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Float_t         trklen_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         trksvtxid_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         trkevtxid_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Int_t           trkntraj_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Int_t           trkpidpdg_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchi_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchipr_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchika_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchipi_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidchimu_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Float_t         trkpidpida_pandoraKalmanShower[92][3];   //[ntracks_pandoraKalmanShower]
   Short_t         trkpidbestplane_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         trkhasPFParticle_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         trkPFParticleID_pandoraKalmanShower[92];   //[ntracks_pandoraKalmanShower]
   Short_t         nvtx_pandora;
   Short_t         vtxId_pandora[164];   //[nvtx_pandora]
   Float_t         vtxx_pandora[164];   //[nvtx_pandora]
   Float_t         vtxy_pandora[164];   //[nvtx_pandora]
   Float_t         vtxz_pandora[164];   //[nvtx_pandora]
   Short_t         vtxhasPFParticle_pandora[164];   //[nvtx_pandora]
   Short_t         vtxPFParticleID_pandora[164];   //[nvtx_pandora]
   Short_t         nvtx_pmtrack;
   Short_t         vtxId_pmtrack[124];   //[nvtx_pmtrack]
   Float_t         vtxx_pmtrack[124];   //[nvtx_pmtrack]
   Float_t         vtxy_pmtrack[124];   //[nvtx_pmtrack]
   Float_t         vtxz_pmtrack[124];   //[nvtx_pmtrack]
   Short_t         vtxhasPFParticle_pmtrack[124];   //[nvtx_pmtrack]
   Short_t         vtxPFParticleID_pmtrack[124];   //[nvtx_pmtrack]
   Short_t         nvtx_trajcluster;
   Short_t         vtxId_trajcluster[129];   //[nvtx_trajcluster]
   Float_t         vtxx_trajcluster[129];   //[nvtx_trajcluster]
   Float_t         vtxy_trajcluster[129];   //[nvtx_trajcluster]
   Float_t         vtxz_trajcluster[129];   //[nvtx_trajcluster]
   Short_t         vtxhasPFParticle_trajcluster[129];   //[nvtx_trajcluster]
   Short_t         vtxPFParticleID_trajcluster[129];   //[nvtx_trajcluster]
   ...
   Float_t         flsTime_simpleFlashCosmic[31];   //[nfls_simpleFlashCosmic]
   Float_t         flsPe_simpleFlashCosmic[31];   //[nfls_simpleFlashCosmic]
   Double_t        flsPePerOpDet_simpleFlashCosmic[31][32];   //[nfls_simpleFlashCosmic]
   Float_t         flsXcenter_simpleFlashCosmic[31];   //[nfls_simpleFlashCosmic]
   Float_t         flsYcenter_simpleFlashCosmic[31];   //[nfls_simpleFlashCosmic]
   Float_t         flsZcenter_simpleFlashCosmic[31];   //[nfls_simpleFlashCosmic]
   Float_t         flsYwidth_simpleFlashCosmic[31];   //[nfls_simpleFlashCosmic]
   Float_t         flsZwidth_simpleFlashCosmic[31];   //[nfls_simpleFlashCosmic]
   Float_t         flsTwidth_simpleFlashCosmic[31];   //[nfls_simpleFlashCosmic]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("AllFIles/ana_hist_ALL.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("AllFiles/ana_hist_ALL.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("AllFiles/ana_hist_ALL.root:/analysistree");
