...
// Mon Apr 13 05:13:40 2020 by ROOT version 6.10/02
// from TTree Event/Event Tree
// found on file: NuCCanalyser_CCCoh_Small_Sample.root
//////////////////////////////////////////////////////////

#ifndef SmallSampleEvent_h
#define SmallSampleEvent_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //Float_t         trk_dedx[50][3][ntkhits[ntrks][3]];   //[ntrks]
   //Float_t         trk_dqdx[50][3][ntkhits[ntrks][3]];   //[ntrks]
   //Float_t         trk_resrange[50][3][ntkhits[ntrks][3]];   //[ntrks]
   //Float_t         trkxyz[50][3][ntkhits[ntrks][3]][3];   //[ntrks]
   Float_t         trk_dedx[50][3][1000];   //[ntrks]
   Float_t         trk_dqdx[50][3][1000];   //[ntrks]
   Float_t         trk_resrange[50][3][1000];   //[ntrks]
   Float_t         trkxyz[50][3][1000][3];   //[ntrks]
   Int_t           ntrkhits[50];   //[ntrks]
   //Float_t         trk_trjx[50][ntrkhits[ntrks]];   //[ntrks]
   //Float_t         trk_trjy[50][ntrkhits[ntrks]];   //[ntrks]
   //Float_t         trk_trjz[50][ntrkhits[ntrks]];   //[ntrks]
   Float_t         trk_trjx[50][1000];   //[ntrks]
   Float_t         trk_trjy[50][1000];   //[ntrks]
   Float_t         trk_trjz[50][1000];   //[ntrks]
   Int_t           nallhits;
   ...
   SmallSampleEvent(TTree *tree=0);
   virtual ~SmallSampleEvent();
...
#ifdef SmallSampleEvent_cxx
SmallSampleEvent::SmallSampleEvent(TTree *tree) : fChain(0) 
{
...
SmallSampleEvent::~SmallSampleEvent()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SmallSampleEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SmallSampleEvent::LoadTree(Long64_t entry)
{
...
void SmallSampleEvent::Init(TTree *tree)
{
...
Bool_t SmallSampleEvent::Notify()
{
...
void SmallSampleEvent::Show(Long64_t entry)
{
...
Int_t SmallSampleEvent::Cut(Long64_t entry)
{
...
#endif // #ifdef SmallSampleEvent_cxx
