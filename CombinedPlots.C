...
for (int i = 0; i < m; i++)
   ...
   NCResDoCA[i] = NCResDoCA[i]*100/hNCResDoCA->GetEntries();
   NCDISDoCA[i] = NCDISDoCA[i]*100/hNCDISDoCA->GetEntries();
...
for (int i = 0; i < j; i++)
   ...
   NCResVA[i] = NCResVA[i]*100/hNCResVA->GetEntries();
   NCDISVA[i] = NCDISVA[i]*100/hNCDISVA->GetEntries();
