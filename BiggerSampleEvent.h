...
// Tue Jan 21 16:18:46 2020 by ROOT version 6.10/02
// from TTree Event/Event Tree
// found on file: NuCCanalyser.root
//////////////////////////////////////////////////////////

#ifndef BiggerSampleEvent_h
#define BiggerSampleEvent_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BiggerSampleEvent(TTree *tree=0);
   virtual ~BiggerSampleEvent();
...
#ifdef BiggerSampleEvent_cxx
BiggerSampleEvent::BiggerSampleEvent(TTree *tree) : fChain(0) 
{
...
BiggerSampleEvent::~BiggerSampleEvent()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BiggerSampleEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BiggerSampleEvent::LoadTree(Long64_t entry)
{
...
void BiggerSampleEvent::Init(TTree *tree)
{
...
Bool_t BiggerSampleEvent::Notify()
{
...
void BiggerSampleEvent::Show(Long64_t entry)
{
...
Int_t BiggerSampleEvent::Cut(Long64_t entry)
{
...
#endif // #ifdef BiggerSampleEvent_cxx
