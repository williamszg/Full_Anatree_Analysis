...
// Sun Sep 29 16:58:05 2019 by ROOT version 6.10/02
// from TTree Event/Event Tree
// found on file: ../nucc_nu_overlay_run1_big_mcc9.root
//////////////////////////////////////////////////////////

#ifndef WouterRun1BigEvent_h
#define WouterRun1BigEvent_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   WouterRun1BigEvent(TTree *tree=0);
   virtual ~WouterRun1BigEvent();
...
#ifdef WouterRun1BigEvent_cxx
WouterRun1BigEvent::WouterRun1BigEvent(TTree *tree) : fChain(0) 
{
...
WouterRun1BigEvent::~WouterRun1BigEvent()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t WouterRun1BigEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t WouterRun1BigEvent::LoadTree(Long64_t entry)
{
...
void WouterRun1BigEvent::Init(TTree *tree)
{
...
Bool_t WouterRun1BigEvent::Notify()
{
...
void WouterRun1BigEvent::Show(Long64_t entry)
{
...
Int_t WouterRun1BigEvent::Cut(Long64_t entry)
{
...
#endif // #ifdef WouterRun1BigEvent_cxx
