...
// Thu May 28 13:37:07 2020 by ROOT version 6.10/02
// from TTree Event/Event Tree
// found on file: /media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NuCCanalyser_CCCoh_346.root
//////////////////////////////////////////////////////////
...
#ifdef SignalEvent_cxx
SignalEvent::SignalEvent(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NuCCanalyser_CCCoh_346.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NuCCanalyser_CCCoh_346.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NuCCanalyser_CCCoh_346.root:/NuCCanalyzer");
...
Int_t SignalEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SignalEvent::LoadTree(Long64_t entry)
{
...
void SignalEvent::Init(TTree *tree)
{
...
void SignalEvent::Show(Long64_t entry)
{
...
Int_t SignalEvent::Cut(Long64_t entry)
{
