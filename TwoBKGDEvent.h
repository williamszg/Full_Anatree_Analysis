...
// Wed Apr 22 13:37:13 2020 by ROOT version 6.12/06
...
#ifndef TwoBKGDEvent_h
#define TwoBKGDEvent_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwoBKGDEvent(TTree *tree=0);
   virtual ~TwoBKGDEvent();
...
#ifdef TwoBKGDEvent_cxx
TwoBKGDEvent::TwoBKGDEvent(TTree *tree) : fChain(0) 
{
...
TwoBKGDEvent::~TwoBKGDEvent()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwoBKGDEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwoBKGDEvent::LoadTree(Long64_t entry)
{
...
void TwoBKGDEvent::Init(TTree *tree)
{
...
void TwoBKGDEvent::Show(Long64_t entry)
{
...
Int_t TwoBKGDEvent::Cut(Long64_t entry)
{
