...
// Mon Apr 13 13:21:08 2020 by ROOT version 6.10/02
// from TTree Daughters/Daughters Tree
// found on file: NuCCanalyser_CCCoh_Quick.root
//////////////////////////////////////////////////////////

#ifndef QuickCheckDaughters_h
#define QuickCheckDaughters_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          ntrkspshits;
   UInt_t          ntrkhits;
   Float_t         track_sps_pos[814][3];   //[ntrkspshits]
   Int_t           track_hit_plane[814];   //[ntrkhits]
   Float_t         track_hit_charge[814];   //[ntrkhits]
   ...
   QuickCheckDaughters(TTree *tree=0);
   virtual ~QuickCheckDaughters();
...
#ifdef QuickCheckDaughters_cxx
QuickCheckDaughters::QuickCheckDaughters(TTree *tree) : fChain(0) 
{
...
QuickCheckDaughters::~QuickCheckDaughters()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t QuickCheckDaughters::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t QuickCheckDaughters::LoadTree(Long64_t entry)
{
...
void QuickCheckDaughters::Init(TTree *tree)
{
...
Bool_t QuickCheckDaughters::Notify()
{
...
void QuickCheckDaughters::Show(Long64_t entry)
{
...
Int_t QuickCheckDaughters::Cut(Long64_t entry)
{
...
#endif // #ifdef QuickCheckDaughters_cxx
