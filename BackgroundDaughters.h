...
// Mon Jun  1 15:46:28 2020 by ROOT version 6.10/02
...
#ifndef BackgroundDaughters_h
#define BackgroundDaughters_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          ntrkspshits;
   UInt_t          ntrkhits;
   Float_t         track_sps_pos[4107][3];   //[ntrkspshits]
   Int_t           track_hit_plane[4107];   //[ntrkhits]
   Float_t         track_hit_charge[4107];   //[ntrkhits]
   ...
   BackgroundDaughters(TTree *tree=0);
   virtual ~BackgroundDaughters();
...
#ifdef BackgroundDaughters_cxx
BackgroundDaughters::BackgroundDaughters(TTree *tree) : fChain(0) 
{
...
BackgroundDaughters::~BackgroundDaughters()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BackgroundDaughters::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BackgroundDaughters::LoadTree(Long64_t entry)
{
...
void BackgroundDaughters::Init(TTree *tree)
{
...
Bool_t BackgroundDaughters::Notify()
{
...
void BackgroundDaughters::Show(Long64_t entry)
{
...
Int_t BackgroundDaughters::Cut(Long64_t entry)
{
...
#endif // #ifdef BackgroundDaughters_cxx
