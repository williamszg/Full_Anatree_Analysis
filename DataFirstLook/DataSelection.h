...
// Tue Dec  1 10:52:51 2020 by ROOT version 6.10/02
// from TTree NeutrinoSelectionFilter/Neutrino Selection TTree
// found on file: /media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/data_bnb_mcc9.1_v08_00_00_25_reco2_C1_beam_good_reco2_5e19.root
//////////////////////////////////////////////////////////
...
#ifdef DataSelection_cxx
DataSelection::DataSelection(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/data_bnb_mcc9.1_v08_00_00_25_reco2_C1_beam_good_reco2_5e19.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/data_bnb_mcc9.1_v08_00_00_25_reco2_C1_beam_good_reco2_5e19.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/data_bnb_mcc9.1_v08_00_00_25_reco2_C1_beam_good_reco2_5e19.root:/nuselection");
...
Int_t DataSelection::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DataSelection::LoadTree(Long64_t entry)
{
...
void DataSelection::Init(TTree *tree)
{
...
void DataSelection::Show(Long64_t entry)
{
...
Int_t DataSelection::Cut(Long64_t entry)
{
