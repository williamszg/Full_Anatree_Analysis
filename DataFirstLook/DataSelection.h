...
// found on file: /media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NeutrinoSelectionFilter_Data.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NeutrinoSelectionFilter_Data.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NeutrinoSelectionFilter_Data.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NeutrinoSelectionFilter_Data.root:/nuselection");
