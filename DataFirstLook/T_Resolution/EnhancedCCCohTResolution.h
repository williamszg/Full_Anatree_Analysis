...
// Mon Sep 27 11:39:28 2021 by ROOT version 6.12/06
// from TTree NeutrinoSelectionFilter/Neutrino Selection TTree
// found on file: /pnfs/uboone/persistent/users/zwilliam/cccoh_zgrw_new_sample/cccoh_zgrw_full/UpdatedVertexActivity/NeutrinoSelectionFilter_CCCoh.root
//////////////////////////////////////////////////////////

#ifndef EnhancedCCCohTResolution_h
#define EnhancedCCCohTResolution_h
...
class EnhancedCCCohTResolution {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EnhancedCCCohTResolution(TTree *tree=0);
   virtual ~EnhancedCCCohTResolution();
...
#ifdef EnhancedCCCohTResolution_cxx
EnhancedCCCohTResolution::EnhancedCCCohTResolution(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/uboone/persistent/users/zwilliam/cccoh_zgrw_new_sample/cccoh_zgrw_full/UpdatedVertexActivity/NeutrinoSelectionFilter_CCCoh.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/uboone/persistent/users/zwilliam/cccoh_zgrw_new_sample/cccoh_zgrw_full/UpdatedVertexActivity/NeutrinoSelectionFilter_CCCoh.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/pnfs/uboone/persistent/users/zwilliam/cccoh_zgrw_new_sample/cccoh_zgrw_full/UpdatedVertexActivity/NeutrinoSelectionFilter_CCCoh.root:/nuselection");
...
EnhancedCCCohTResolution::~EnhancedCCCohTResolution()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EnhancedCCCohTResolution::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EnhancedCCCohTResolution::LoadTree(Long64_t entry)
{
...
void EnhancedCCCohTResolution::Init(TTree *tree)
{
...
Bool_t EnhancedCCCohTResolution::Notify()
{
...
void EnhancedCCCohTResolution::Show(Long64_t entry)
{
...
Int_t EnhancedCCCohTResolution::Cut(Long64_t entry)
{
...
#endif // #ifdef EnhancedCCCohTResolution_cxx
