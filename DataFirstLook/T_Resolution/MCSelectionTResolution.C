#define MCSelectionTResolution_cxx
#include "MCSelectionTResolution.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void MCSelectionTResolution::Loop()
{
   // ===============================================
   ...
   TFile *TMCInfo = new TFile("MC_Histograms_TResolution.root", "RECREATE");
