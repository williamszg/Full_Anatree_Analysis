...
// found on file: /media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NeutrinoSelectionFilter_EXT.root
//////////////////////////////////////////////////////////

#ifndef EXTSelection_h
#define EXTSelection_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EXTSelection(TTree *tree=0);
   virtual ~EXTSelection();
...
#ifdef EXTSelection_cxx
EXTSelection::EXTSelection(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NeutrinoSelectionFilter_EXT.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NeutrinoSelectionFilter_EXT.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NeutrinoSelectionFilter_EXT.root:/nuselection");
...
Int_t EXTSelection::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EXTSelection::LoadTree(Long64_t entry)
{
...
void EXTSelection::Init(TTree *tree)
{
...
void EXTSelection::Show(Long64_t entry)
{
...
Int_t EXTSelection::Cut(Long64_t entry)
{
