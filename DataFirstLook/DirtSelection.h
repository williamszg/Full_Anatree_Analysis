...
// Wed Jun 23 09:46:08 2021 by ROOT version 6.10/02
...
#ifndef DirtSelection_h
#define DirtSelection_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   DirtSelection(TTree *tree=0);
   virtual ~DirtSelection();
...
#ifdef DirtSelection_cxx
DirtSelection::DirtSelection(TTree *tree) : fChain(0) 
{
...
DirtSelection::~DirtSelection()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DirtSelection::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DirtSelection::LoadTree(Long64_t entry)
{
...
void DirtSelection::Init(TTree *tree)
{
...
void DirtSelection::Show(Long64_t entry)
{
...
Int_t DirtSelection::Cut(Long64_t entry)
{
