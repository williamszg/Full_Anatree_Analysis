...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   POT_Counting_BKGD(TTree *tree=0);
   virtual ~POT_Counting_BKGD();
...
#ifdef POT_Counting_BKGD_cxx
POT_Counting_BKGD::POT_Counting_BKGD(TTree *tree) : fChain(0) 
{
...
POT_Counting_BKGD::~POT_Counting_BKGD()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t POT_Counting_BKGD::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t POT_Counting_BKGD::LoadTree(Long64_t entry)
{
...
void POT_Counting_BKGD::Init(TTree *tree)
{
...
Bool_t POT_Counting_BKGD::Notify()
{
...
void POT_Counting_BKGD::Show(Long64_t entry)
{
...
Int_t POT_Counting_BKGD::Cut(Long64_t entry)
{
...
#endif // #ifdef POT_Counting_BKGD_cxx
