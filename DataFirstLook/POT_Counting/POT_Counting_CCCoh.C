#define POT_Counting_CCCoh_cxx
#include "POT_Counting_CCCoh.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

TH1D *hPOTCounting = new TH1D("hPOTCounting", "The POT for this file", 1000, 0, 100E18);

void POT_Counting_CCCoh::Loop()
{
   if (fChain == 0) return;
