...
// Wed Oct 13 13:54:16 2021 by ROOT version 6.12/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *trk_mcs_pion_mom_v;
   vector<float>   *trk_range_pion_mom_v;
   vector<float>   *trk_energy_proton_v;
   vector<float>   *trk_energy_muon_v;
   vector<float>   *trk_energy_pion_v;
   ...
   TBranch        *b_trk_mcs_pion_mom_v;   //!
   TBranch        *b_trk_range_pion_mom_v;   //!
   TBranch        *b_trk_energy_proton_v;   //!
   TBranch        *b_trk_energy_muon_v;   //!
   TBranch        *b_trk_energy_pion_v;   //!
...
void MCSelection::Init(TTree *tree)
{
   ...
   trk_mcs_pion_mom_v = 0;
   trk_range_pion_mom_v = 0;
   ...
   fChain->SetBranchAddress("trk_mcs_pion_mom_v", &trk_mcs_pion_mom_v, &b_trk_mcs_pion_mom_v);
   fChain->SetBranchAddress("trk_range_pion_mom_v", &trk_range_pion_mom_v, &b_trk_range_pion_mom_v);
   ...
   fChain->SetBranchAddress("trk_energy_pion_v", &trk_energy_pion_v, &b_trk_energy_pion_v);
