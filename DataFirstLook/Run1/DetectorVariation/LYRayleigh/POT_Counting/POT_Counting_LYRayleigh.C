#define POT_Counting_LYRayleigh_cxx
#include "POT_Counting_LYRayleigh.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void POT_Counting_LYRayleigh::Loop()
{
   if (fChain == 0) return;
   ...
   // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   TFile *TMCInfo = new TFile("LYRayleigh_POT.root", "CREATE");
