#define POT_Counting_WireModThetaYZ_cxx
#include "POT_Counting_WireModThetaYZ.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void POT_Counting_WireModThetaYZ::Loop()
{
   if (fChain == 0) return;
   ...
   // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   TFile *TMCInfo = new TFile("WireModThetaYZ_POT.root", "RECREATE");
