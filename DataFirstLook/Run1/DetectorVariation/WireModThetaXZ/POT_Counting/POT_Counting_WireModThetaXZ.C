#define POT_Counting_WireModThetaXZ_cxx
#include "POT_Counting_WireModThetaXZ.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void POT_Counting_WireModThetaXZ::Loop()
{
   if (fChain == 0) return;
   ...
   // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   TFile *TMCInfo = new TFile("WireModThetaXZ_POT.root", "CREATE");
