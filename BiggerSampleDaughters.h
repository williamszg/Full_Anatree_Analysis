...
// Tue Jan 21 16:19:09 2020 by ROOT version 6.10/02
// from TTree Daughters/Daughters Tree
// found on file: NuCCanalyser.root
//////////////////////////////////////////////////////////

#ifndef BiggerSampleDaughters_h
#define BiggerSampleDaughters_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BiggerSampleDaughters(TTree *tree=0);
   virtual ~BiggerSampleDaughters();
...
#ifdef BiggerSampleDaughters_cxx
BiggerSampleDaughters::BiggerSampleDaughters(TTree *tree) : fChain(0) 
{
...
BiggerSampleDaughters::~BiggerSampleDaughters()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BiggerSampleDaughters::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BiggerSampleDaughters::LoadTree(Long64_t entry)
{
...
void BiggerSampleDaughters::Init(TTree *tree)
{
...
Bool_t BiggerSampleDaughters::Notify()
{
...
void BiggerSampleDaughters::Show(Long64_t entry)
{
...
Int_t BiggerSampleDaughters::Cut(Long64_t entry)
{
...
#endif // #ifdef BiggerSampleDaughters_cxx
