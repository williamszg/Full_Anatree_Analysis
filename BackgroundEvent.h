...
// Mon Jun  1 15:45:51 2020 by ROOT version 6.10/02
// from TTree Event/Event Tree
// found on file: /media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NuCCanalyser_BKGD_33304.root
//////////////////////////////////////////////////////////

#ifndef BackgroundEvent_h
#define BackgroundEvent_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           ntrks;
   Int_t           trk_cosmic[50];   //[ntrks]
   Int_t           trk_id[50];   //[ntrks]
   ...
   Float_t         trk_theta[50];   //[ntrks]
   Float_t         trk_phi[50];   //[ntrks]
   Float_t         trk_startmom[50];   //[ntrks]
   Float_t         trk_startmom_x[50];   //[ntrks]
   Float_t         trk_startmom_y[50];   //[ntrks]
   Float_t         trk_startmom_z[50];   //[ntrks]
   Float_t         trk_endmom[50];   //[ntrks]
   Float_t         trk_endmom_x[50];   //[ntrks]
   Float_t         trk_endmom_y[50];   //[ntrks]
   Float_t         trk_endmom_z[50];   //[ntrks]
   ...
   TBranch        *b_trk_theta;   //!
   TBranch        *b_trk_phi;   //!
   TBranch        *b_trk_startmom;   //!
   TBranch        *b_trk_startmom_x;   //!
   TBranch        *b_trk_startmom_y;   //!
   TBranch        *b_trk_startmom_z;   //!
   TBranch        *b_trk_endmom;   //!
   TBranch        *b_trk_endmom_x;   //!
   TBranch        *b_trk_endmom_y;   //!
   TBranch        *b_trk_endmom_z;   //!
   TBranch        *b_trk_ke;   //!
   TBranch        *b_trk_range;   //!
   TBranch        *b_trk_pitch;   //!
   TBranch        *b_ntkhits;   //!
...
#ifdef BackgroundEvent_cxx
BackgroundEvent::BackgroundEvent(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NuCCanalyser_BKGD_33304.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NuCCanalyser_BKGD_33304.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/media/zwilliams/Monsivais's External Hard Drive/CCCohFiles/NuCCanalyser_BKGD_33304.root:/NuCCanalyzer");
...
Int_t BackgroundEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BackgroundEvent::LoadTree(Long64_t entry)
{
...
void BackgroundEvent::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("trk_cosmic", trk_cosmic, &b_trk_cosmic);
   ...
   fChain->SetBranchAddress("trk_startmom", trk_startmom, &b_trk_startmom);
   fChain->SetBranchAddress("trk_startmom_x", trk_startmom_x, &b_trk_startmom_x);
   fChain->SetBranchAddress("trk_startmom_y", trk_startmom_y, &b_trk_startmom_y);
   fChain->SetBranchAddress("trk_startmom_z", trk_startmom_z, &b_trk_startmom_z);
   fChain->SetBranchAddress("trk_endmom", trk_endmom, &b_trk_endmom);
   fChain->SetBranchAddress("trk_endmom_x", trk_endmom_x, &b_trk_endmom_x);
   fChain->SetBranchAddress("trk_endmom_y", trk_endmom_y, &b_trk_endmom_y);
   fChain->SetBranchAddress("trk_endmom_z", trk_endmom_z, &b_trk_endmom_z);
...
void BackgroundEvent::Show(Long64_t entry)
{
...
Int_t BackgroundEvent::Cut(Long64_t entry)
{
...
#endif // #ifdef BackgroundEvent_cxx
