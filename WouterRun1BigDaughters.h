...
// Sun Sep 29 17:00:32 2019 by ROOT version 6.10/02
// from TTree Daughters/Daughters Tree
// found on file: ../nucc_nu_overlay_run1_big_mcc9.root
//////////////////////////////////////////////////////////

#ifndef WouterRun1BigDaughters_h
#define WouterRun1BigDaughters_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   WouterRun1BigDaughters(TTree *tree=0);
   virtual ~WouterRun1BigDaughters();
...
#ifdef WouterRun1BigDaughters_cxx
WouterRun1BigDaughters::WouterRun1BigDaughters(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../nucc_nu_overlay_run1_big_mcc9.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../nucc_nu_overlay_run1_big_mcc9.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../nucc_nu_overlay_run1_big_mcc9.root:/NuCCanalyzer");
...
WouterRun1BigDaughters::~WouterRun1BigDaughters()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t WouterRun1BigDaughters::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t WouterRun1BigDaughters::LoadTree(Long64_t entry)
{
...
void WouterRun1BigDaughters::Init(TTree *tree)
{
...
Bool_t WouterRun1BigDaughters::Notify()
{
...
void WouterRun1BigDaughters::Show(Long64_t entry)
{
...
Int_t WouterRun1BigDaughters::Cut(Long64_t entry)
{
...
#endif // #ifdef WouterRun1BigDaughters_cxx
