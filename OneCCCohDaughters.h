...
// Wed Apr 15 03:01:45 2020 by ROOT version 6.10/02
// from TTree Daughters/Daughters Tree
// found on file: NuCCanalyser_CCCoh_2.root
//////////////////////////////////////////////////////////

#ifndef OneCCCohDaughters_h
#define OneCCCohDaughters_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          ntrkspshits;
   UInt_t          ntrkhits;
   Float_t         track_sps_pos[1577][3];   //[ntrkspshits]
   Int_t           track_hit_plane[1577];   //[ntrkhits]
   Float_t         track_hit_charge[1577];   //[ntrkhits]
   ...
   OneCCCohDaughters(TTree *tree=0);
   virtual ~OneCCCohDaughters();
...
#ifdef OneCCCohDaughters_cxx
OneCCCohDaughters::OneCCCohDaughters(TTree *tree) : fChain(0) 
{
...
OneCCCohDaughters::~OneCCCohDaughters()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t OneCCCohDaughters::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t OneCCCohDaughters::LoadTree(Long64_t entry)
{
...
void OneCCCohDaughters::Init(TTree *tree)
{
...
Bool_t OneCCCohDaughters::Notify()
{
...
void OneCCCohDaughters::Show(Long64_t entry)
{
...
Int_t OneCCCohDaughters::Cut(Long64_t entry)
{
...
#endif // #ifdef OneCCCohDaughters_cxx
