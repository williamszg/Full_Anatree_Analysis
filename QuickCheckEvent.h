...
// Mon Apr 13 13:20:43 2020 by ROOT version 6.10/02
// from TTree Event/Event Tree
// found on file: NuCCanalyser_CCCoh_Quick.root
//////////////////////////////////////////////////////////

#ifndef QuickCheckEvent_h
#define QuickCheckEvent_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nallhits;
   Int_t           hit_plane[26337];   //[nallhits]
   Int_t           hit_wire[26337];   //[nallhits]
   Int_t           hit_channel[26337];   //[nallhits]
   Float_t         hit_peakT[26337];   //[nallhits]
   Float_t         hit_charge[26337];   //[nallhits]
   Float_t         hit_ph[26337];   //[nallhits]
   Float_t         hit_tstart[26337];   //[nallhits]
   Float_t         hit_tend[26337];   //[nallhits]
   Int_t           hit_trkid[26337];   //[nallhits]
   Int_t           hit_trkkey[26337];   //[nallhits]
   Int_t           hit_clukey[26337];   //[nallhits]
   Float_t         hit_dQds[26337];   //[nallhits]
   Float_t         hit_dEds[26337];   //[nallhits]
   Float_t         hit_ds[26337];   //[nallhits]
   Float_t         hit_resrange[26337];   //[nallhits]
   Float_t         hit_xt[26337];   //[nallhits]
   Float_t         hit_yt[26337];   //[nallhits]
   Float_t         hit_zt[26337];   //[nallhits]
   Float_t         hit_xc[26337];   //[nallhits]
   Float_t         hit_x[26337];   //[nallhits]
   Float_t         hit_y[26337];   //[nallhits]
   Float_t         hit_z[26337];   //[nallhits]
   ...
   QuickCheckEvent(TTree *tree=0);
   virtual ~QuickCheckEvent();
...
#ifdef QuickCheckEvent_cxx
QuickCheckEvent::QuickCheckEvent(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("NuCCanalyser_CCCoh_Quick.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("NuCCanalyser_CCCoh_Quick.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("NuCCanalyser_CCCoh_Quick.root:/NuCCanalyzer");
...
QuickCheckEvent::~QuickCheckEvent()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t QuickCheckEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t QuickCheckEvent::LoadTree(Long64_t entry)
{
...
void QuickCheckEvent::Init(TTree *tree)
{
...
void QuickCheckEvent::Show(Long64_t entry)
{
...
Int_t QuickCheckEvent::Cut(Long64_t entry)
{
...
#endif // #ifdef QuickCheckEvent_cxx
