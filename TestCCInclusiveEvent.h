...
// Thu Jan 16 09:04:03 2020 by ROOT version 6.10/02
// from TTree Event/Event Tree
// found on file: NuCCanalyser.root
//////////////////////////////////////////////////////////

#ifndef TestCCInclusiveEvent_h
#define TestCCInclusiveEvent_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TestCCInclusiveEvent(TTree *tree=0);
   virtual ~TestCCInclusiveEvent();
...
#ifdef TestCCInclusiveEvent_cxx
TestCCInclusiveEvent::TestCCInclusiveEvent(TTree *tree) : fChain(0) 
{
...
TestCCInclusiveEvent::~TestCCInclusiveEvent()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TestCCInclusiveEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TestCCInclusiveEvent::LoadTree(Long64_t entry)
{
...
void TestCCInclusiveEvent::Init(TTree *tree)
{
...
Bool_t TestCCInclusiveEvent::Notify()
{
...
void TestCCInclusiveEvent::Show(Long64_t entry)
{
...
Int_t TestCCInclusiveEvent::Cut(Long64_t entry)
{
...
#endif // #ifdef TestCCInclusiveEvent_cxx
